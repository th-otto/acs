...
[0001c0dc] 4eb9 0001 c190            jsr        $0001C190
[0001c0e2] 7004                      moveq.l    #4,d0
[0001c0e4] 2079 0010 1f12            movea.l    ACSblk,a0
[0001c0ea] c068 0266                 and.w      614(a0),d0
[0001c0ee] 6712                      beq.s      $0001C102
[0001c0f0] 2279 000d 99d6            movea.l    $000D99D6,a1
[0001c0f6] 41d7                      lea.l      (a7),a0
[0001c0f8] 7001                      moveq.l    #1,d0
[0001c0fa] 4eb9 0006 be76            jsr        $0006BE76
[0001c100] 600a                      bra.s      $0001C10C
[0001c102] 41d7                      lea.l      (a7),a0
[0001c104] 7001                      moveq.l    #1,d0
[0001c106] 4eb9 0005 17fe            jsr        $000517FE
...
[0001c1a6] 4eb9 0007 6950            jsr        $00076950
[0001c1ac] 41f9 000a 0ee2            lea.l      $000A0EE2,a0
[0001c1b2] 226a 003c                 movea.l    60(a2),a1
[0001c1b6] b3c8                      cmpa.l     a0,a1
[0001c1b8] 6606                      bne.s      $0001C1C0
[0001c1ba] 197c 0030 0001            move.b     #$30,1(a4)
[0001c1c0] 226a 003c                 movea.l    60(a2),a1
[0001c1c4] b3fc 000a 0e54            cmpa.l     #$000A0E54,a1
[0001c1ca] 6606                      bne.s      $0001C1D2
[0001c1cc] 197c 0031 0001            move.b     #$31,1(a4)
[0001c1d2] 226a 003c                 movea.l    60(a2),a1
[0001c1d6] b3fc 000a 0f70            cmpa.l     #$000A0F70,a1
[0001c1dc] 6606                      bne.s      $0001C1E4
[0001c1de] 197c 0032 0001            move.b     #$32,1(a4)
[0001c1e4] 226a 003c                 movea.l    60(a2),a1
[0001c1e8] b3fc 000a 0ffe            cmpa.l     #$000A0FFE,a1
[0001c1ee] 6606                      bne.s      $0001C1F6
[0001c1f0] 197c 0033 0001            move.b     #$33,1(a4)
[0001c1f6] 226a 003c                 movea.l    60(a2),a1
[0001c1fa] b3fc 000a 1088            cmpa.l     #$000A1088,a1
[0001c200] 6606                      bne.s      $0001C208
...
[0001c36c] 6100 fe22                 bsr        $0001C190
[0001c370] 41d7                      lea.l      (a7),a0
[0001c372] 4eb9 0007 69b0            jsr        $000769B0
...
[0001c388] 672e                      beq.s      $0001C3B8
[0001c38a] 43d7                      lea.l      (a7),a1
[0001c38c] 4eb9 0007 6950            jsr        $00076950
[0001c392] 206a 0004                 movea.l    4(a2),a0
[0001c396] 2068 0004                 movea.l    4(a0),a0
[0001c39a] 4eb9 0004 7e26            jsr        $00047E26
...
[0001c46c] 6708                      beq.s      $0001C476
[0001c46e] 907c 270e                 sub.w      #$270E,d0
[0001c472] 6712                      beq.s      $0001C486
[0001c474] 601e                      bra.s      $0001C494
[0001c476] 204a                      movea.l    a2,a0
[0001c478] 6100 fedc                 bsr        $0001C356
[0001c47c] 204a                      movea.l    a2,a0
[0001c47e] 4eb9 0001 c6ac            jsr        $0001C6AC
[0001c484] 601c                      bra.s      $0001C4A2
[0001c486] 226b 0004                 movea.l    4(a3),a1
[0001c48a] 204a                      movea.l    a2,a0
[0001c48c] 4eb9 0001 45a2            jsr        $000145A2
[0001c492] 600e                      bra.s      $0001C4A2
[0001c494] 224c                      movea.l    a4,a1
[0001c496] 3003                      move.w     d3,d0
[0001c498] 204a                      movea.l    a2,a0
[0001c49a] 4eb9 0005 1276            jsr        $00051276
[0001c4a0] 6002                      bra.s      $0001C4A4
...
[0001c4b0] 670c                      beq.s      $0001C4BE
[0001c4b2] b03c 007c                 cmp.b      #$7C,d0
[0001c4b6] 6706                      beq.s      $0001C4BE
[0001c4b8] b03c 005d                 cmp.b      #$5D,d0
[0001c4bc] 66ee                      bne.s      $0001C4AC
[0001c4be] 1010                      move.b     (a0),d0
[0001c4c0] 670e                      beq.s      $0001C4D0
[0001c4c2] b03c 005d                 cmp.b      #$5D,d0
[0001c4c6] 6608                      bne.s      $0001C4D0
[0001c4c8] 0c28 005b ffff            cmpi.b     #$5B,-1(a0)
[0001c4ce] 67dc                      beq.s      $0001C4AC
[0001c4d0] 0c10 007c                 cmpi.b     #$7C,(a0)
[0001c4d4] 6604                      bne.s      $0001C4DA
[0001c4d6] 7001                      moveq.l    #1,d0
[0001c4d8] 6002                      bra.s      $0001C4DC
...
[0001c6d4] 4eb9 0007 6f44            jsr        $00076F44
[0001c6da] 6014                      bra.s      $0001C6F0
...
[0001c6ea] 4eb9 0007 6f44            jsr        $00076F44
[0001c6f0] 204b                      movea.l    a3,a0
[0001c6f2] 4eb9 0004 7e26            jsr        $00047E26
[0001c6f8] 204a                      movea.l    a2,a0
[0001c6fa] 4eb9 0005 0330            jsr        $00050330
