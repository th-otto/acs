...
p_string_3:
		...
		ext.w      d0
		move.w     d0,-(a7)
		lea.l      x99f80-x99f7e(a2),a1
		movea.l    a4,a0
		jsr        sprintf
		addq.w     #2,a7
		bra.s      p_string_5
p_string_4:
		lea.l      x99f86-x99f7e(a2),a1
		movea.l    a4,a0
		jsr        strcpy
		bra.s      p_string_5
p_string_2:
...
out_acs_1:
		...
		move.w     86(a2),-(a7)
		move.w     #$012C,-(a7)
		pea.l      x9a373-x99f7e(a3)
		lea.l      x9a327-x99f7e(a3),a1
		movea.l    a4,a0
		jsr        sprintf
		lea.l      12(a7),a7
		movea.l    a4,a0
		...
		lea.l      (a7),a0
		bsr        p_string
		lea.l      x9a37b-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    124(a2),a0
		bsr        out_label2
		lea.l      x9a388-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    128(a2),a0
		bsr        out_label2
		lea.l      x9a390-x99f7e(a3),a0
		jsr        save_string
		lea.l      132(a2),a5
		clr.w      d3
		bra.s      out_acs_3
...
out_acs_3:
		cmp.w      #$0020,d3
		blt.s      out_acs_7
		lea.l      x9a3dc-x99f7e(a3),a0
		jsr        save_string
		clr.w      d3
		lea.l      32(a7),a5
		bra.s      out_acs_8
out_acs_13:
		lea.l      x9a3f0-x99f7e(a3),a0
		jsr        save_string
		cmp.w      #$0021,d3
		bge.s      out_acs_9
		moveq.l    #44,d4
...
out_acs_8:
		cmp.w      #$0022,d3
		blt.s      out_acs_13
		lea.l      x9a3ff-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a40c-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a42e-x99f7e(a3),a0
		jsr        save_string
		lea.l      x99f7f-x99f7e(a3),a1
		movea.l    532(a2),a0
		bsr        out_label
		lea.l      x9a44a-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a458-x99f7e(a3),a1
		movea.l    536(a2),a0
		bsr        out_label
		lea.l      x9a45b-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    540(a2),a0
		bsr        out_label
		lea.l      x9a46c-x99f7e(a3),a0
		jsr        save_string
		move.w     544(a2),d0
		beq.s      out_acs_14
		lea.l      x9a482-x99f7e(a3),a0
		bra.s      out_acs_15
out_acs_14:
		lea.l      x9a487-x99f7e(a3),a0
out_acs_15:
		jsr        save_string
		lea.l      x9a48d-x99f7e(a3),a0
		jsr        save_string
		move.w     546(a2),d0
		beq.s      out_acs_16
		lea.l      x9a482-x99f7e(a3),a0
...
out_acs_17:
		jsr        save_string
		lea.l      x9a49f-x99f7e(a3),a0
		jsr        save_string
		move.w     548(a2),-(a7)
		lea.l      x9a4b3-x99f7e(a3),a1
		movea.l    a4,a0
		jsr        sprintf
		addq.w     #2,a7
		movea.l    a4,a0
		jsr        save_string
		lea.l      x9a4c0-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a4cc-x99f7e(a3),a1
		movea.l    550(a2),a0
		bsr        out_label
		lea.l      x9a4d5-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    554(a2),a0
		bsr        out_label
		lea.l      x9a4e2-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    558(a2),a0
		bsr        out_label
		lea.l      x9a4f1-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    562(a2),a0
		bsr        out_label
		lea.l      x9a4fe-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    566(a2),a0
		bsr        out_label
		lea.l      x9a510-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    570(a2),a0
		bsr        out_label
		lea.l      x9a51e-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    574(a2),a0
		bsr        out_label
		lea.l      x9a52b-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    578(a2),a0
		bsr        out_label
		lea.l      x9a536-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    582(a2),a0
		bsr        out_label
		lea.l      x9a547-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    586(a2),a0
		bsr        out_label
		lea.l      x9a554-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    590(a2),a0
		bsr        out_label
		lea.l      x9a561-x99f7e(a3),a0
		jsr        save_string
		move.w     594(a2),-(a7)
		lea.l      x9a572-x99f7e(a3),a1
		movea.l    a4,a0
		jsr        sprintf
		addq.w     #2,a7
		movea.l    a4,a0
...
out_cicon:
		...
		move.l     a3,-(a7)
		move.w     (a2),-(a7)
		lea.l      x9a594-x99f7e(a4),a1
		movea.l    a5,a0
		jsr        sprintf
		addq.w     #8,a7
		movea.l    a5,a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a4),a1
		movea.l    2(a2),a0
		bsr        out_label3
		lea.l      x9a5cc-x99f7e(a4),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a4),a1
		movea.l    6(a2),a0
		bsr        out_label2
		lea.l      x9a5dc-x99f7e(a4),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a4),a1
		movea.l    10(a2),a0
		bsr        out_label3
		lea.l      x9a5ec-x99f7e(a4),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a4),a1
		movea.l    14(a2),a0
		bsr        out_label2
...
out_icon_8:
		...
		bra.s      out_icon_12
out_icon_11:
		lea.l      x9a384-x99f7e(a3),a0
		jsr        save_string
out_icon_12:
		lea.l      x9a7ee-x99f7e(a3),a0
		jsr        save_string
		addq.w     #1,d4
out_icon_2:
		cmp.w      d4,d3
...
out_obj_13:
		...
		and.w      8(a4),d0
		beq.s      out_obj_14
		lea.l      x9a902-x99f7e(a6),a0
		jsr        save_string
		bra.s      out_obj_15
out_obj_14:
		lea.l      x9aa7c-x99f7e(a6),a0
		jsr        save_string
out_obj_15:
		move.w     d7,d0
		ext.l      d0
...
out_obj_18:
		...
		move.l     4(a7),d0
		beq.s      out_obj_19
		lea.l      x9aa8a-x99f7e(a6),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a6),a1
		movea.l    4(a7),a0
		bsr        out_label
		lea.l      x9aa92-x99f7e(a6),a0
		jsr        save_string
out_obj_19:
		move.l     8(a7),d0
		beq.s      out_obj_20
		lea.l      x9aa95-x99f7e(a6),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a6),a1
		movea.l    8(a7),a0
		bsr        out_label
...
out_obj_20:
		move.w     14(a7),-(a7)
		move.w     14(a7),-(a7)
		lea.l      x9aa9c-x99f7e(a6),a1
		movea.l    a3,a0
		jsr        sprintf
		addq.w     #4,a7
		movea.l    a3,a0
		jsr        save_string
		lea.l      x9aab9-x99f7e(a6),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a6),a1
		movea.l    16(a7),a0
		bsr        out_label2
		lea.l      x9aac2-x99f7e(a6),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a6),a1
		movea.l    20(a7),a0
		bsr        out_label2
...
out_user_4:
		movea.l    a5,a0
		jsr        save_string
		lea.l      x9ac1d-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    8(a4),a0
		bsr        out_label
		lea.l      x9ac29-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    12(a4),a0
		bsr        out_label2
		lea.l      x9ac35-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    16(a4),a0
		bsr        out_label2
		lea.l      x9ac41-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    20(a4),a0
		bsr        out_label2
		lea.l      x9ac4d-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    24(a4),a0
		bsr        out_label2
		lea.l      x9ac58-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    28(a4),a0
		bsr        out_label2
		lea.l      x9a186-x99f7e(a3),a0
		jsr        save_string
		addq.w     #1,d4
out_user_2:
		cmp.w      d4,d3
...
out_window_3:
		...
		movea.l    4(a4),a5
		pea.l      22(a4)
		lea.l      x9acb8-x99f7e(a3),a1
		movea.l    a6,a0
		jsr        sprintf
		addq.w     #4,a7
		movea.l    a6,a0
		jsr        save_string
		lea.l      x9accd-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    (a5),a0
		bsr        out_label2
		lea.l      x9acd6-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9ace5-x99f7e(a3),a1
		movea.l    4(a5),a0
		bsr        out_label
		lea.l      x9acf1-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9acff-x99f7e(a3),a1
		movea.l    8(a5),a0
		bsr        out_label
		lea.l      x9ad0e-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9ad1a-x99f7e(a3),a1
		movea.l    12(a5),a0
		bsr        out_label
		lea.l      x9ad23-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9ad2f-x99f7e(a3),a1
		movea.l    16(a5),a0
		bsr        out_label
		lea.l      x9ad38-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    20(a5),a0
		bsr        out_label2
		lea.l      x9ad44-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    24(a5),a0
		bsr        out_label2
		lea.l      x9ad53-x99f7e(a3),a0
		jsr        save_string
		move.w     42(a5),-(a7)
		move.w     40(a5),-(a7)
		move.w     38(a5),-(a7)
		move.w     36(a5),-(a7)
		move.w     34(a5),-(a7)
		lea.l      x9ad7c-x99f7e(a3),a1
		movea.l    a6,a0
		jsr        sprintf
		lea.l      10(a7),a7
		movea.l    a6,a0
		jsr        save_string
		lea.l      x9adba-x99f7e(a3),a0
		jsr        save_string
		move.w     72(a5),-(a7)
		lea.l      x9ade7-x99f7e(a3),a1
		movea.l    a6,a0
		jsr        sprintf
		addq.w     #2,a7
		movea.l    a6,a0
		jsr        save_string
		lea.l      x9adfd-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    74(a5),a0
		bsr        out_label2
		lea.l      x9ae08-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    78(a5),a0
		bsr        out_label2
		move.w     84(a5),-(a7)
		move.w     82(a5),-(a7)
		lea.l      x9ae11-x99f7e(a3),a1
		movea.l    a6,a0
		jsr        sprintf
		addq.w     #4,a7
		movea.l    a6,a0
		jsr        save_string
		lea.l      x9ae3c-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    90(a5),a0
		bsr        out_label2
		lea.l      x9ae4b-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9a384-x99f7e(a3),a1
		movea.l    94(a5),a0
		bsr        out_label2
		lea.l      x9ae57-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9ae63-x99f7e(a3),a1
		movea.l    98(a5),a0
		bsr        out_label
		lea.l      x9ae6c-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9ae7c-x99f7e(a3),a1
		movea.l    102(a5),a0
		bsr        out_label
		lea.l      x9ae89-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9ae97-x99f7e(a3),a1
		movea.l    106(a5),a0
		bsr        out_label
		lea.l      x9aea2-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9aeb0-x99f7e(a3),a1
		movea.l    110(a5),a0
		bsr        out_label
		lea.l      x9aebb-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9aec9-x99f7e(a3),a1
		movea.l    114(a5),a0
		bsr        out_label
		lea.l      x9aed4-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9aee2-x99f7e(a3),a1
		movea.l    118(a5),a0
		bsr        out_label
		lea.l      x9aeed-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9aefc-x99f7e(a3),a1
		movea.l    122(a5),a0
		bsr        out_label
		lea.l      x9af08-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9af15-x99f7e(a3),a1
		movea.l    126(a5),a0
		bsr        out_label
		lea.l      x9af1f-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9af2c-x99f7e(a3),a1
		movea.l    130(a5),a0
		bsr        out_label
		lea.l      x9af36-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9af43-x99f7e(a3),a1
		movea.l    134(a5),a0
		bsr        out_label
		lea.l      x9af4d-x99f7e(a3),a0
		jsr        save_string
		lea.l      x9af5a-x99f7e(a3),a1
		movea.l    138(a5),a0
		bsr        out_label
		lea.l      x9a7ee-x99f7e(a3),a0
		jsr        save_string
...
pp_output_3:
		...
		movea.l    a3,a0
		jsr        save_string
		lea.l      x9af78-x99f7e(a5),a0
		jsr        save_string
		lea.l      x9af9c-x99f7e(a5),a0
		jsr        save_string
		lea.l      x9afb4-x99f7e(a5),a0
		jsr        save_string
		clr.w      d4
		bra.s      pp_output_5
pp_output_8:
...
pp_output_7:
		...
		add.w      d4,d1
		move.w     d1,-(a7)
		lea.l      x9afcd-x99f7e(a5),a1
		movea.l    a3,a0
		jsr        sprintf
		addq.w     #4,a7
		movea.l    a3,a0
		jsr        save_string
		lea.l      x9affa-x99f7e(a5),a0
		jsr        save_string
		addq.w     #1,d5
pp_output_6:
		cmp.w      #$0003,d5
...
pp_output_11:
		...
		bsr        out_declproto
pp_output_13:
		lea.l      x9b085-x99f7e(a5),a0
		jsr        save_string
		lea.l      x9b08d-x99f7e(a5),a0
		jsr        save_string
		lea.l      x9b0a9-x99f7e(a5),a0
		jsr        save_string
		clr.w      d5
		bra.w      pp_output_14
pp_output_19:
...
pp_output_14:
		cmp.w      #$0003,d5
		ble.w      pp_output_19
		lea.l      x9b122-x99f7e(a5),a0
		jsr        save_string
		clr.w      d5
		bra.s      pp_output_20
pp_output_21:
		lea.l      x9b15e-x99f7e(a5),a0
		jsr        save_string
		addq.w     #1,d5
pp_output_20:
		cmp.w      #$0003,d5
		ble.s      pp_output_21
		lea.l      x9b16d-x99f7e(a5),a0
		jsr        save_string
		lea.l      x9b185-x99f7e(a5),a0
		jsr        save_string
		clr.w      d5
		bra.w      pp_output_22
pp_output_27:
...
pp_output_28:
		...
		movea.l    48(a2),a0
		bsr        out_image
		lea.l      x9b203-x99f7e(a5),a1
		movea.l    28(a2),a0
		bsr        out_obj
		lea.l      x9b21a-x99f7e(a5),a1
		movea.l    32(a2),a0
		bsr        out_obj
		lea.l      x9b232-x99f7e(a5),a1
		movea.l    24(a2),a0
		bsr        out_obj
		movea.l    20(a2),a0
		bsr        out_window
...
x99f97:
		dc.b '@%-12s[3]',0
x99fa1:
		dc.b $0d,$0a,'IMPLEMENTATION',$0d,$0a,$0d,$0a,'(*',$09,'Pascal Routines',$09,'*)'
x99fca:
		dc.b $0d,$0a
x99fcc:
		dc.b $0d,$0a,0
...
x9a153:
		dc.b 'Procedure %s( wi: AwindowPtr; obnr, state: Integer '
x9a186:
		dc.b ');',$0d,$0a,0
x9a18b:
...
x9a40c:
		dc.b $0d,$0a,$0d,$0a,'ACSconfig: Aconfig = ',$0d,$0a,$09,'('
x9a429:
		dc.b $0d,$0a,$09,$09,0
x9a42e:
