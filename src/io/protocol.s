...
x97f15:
		dc.b $0d,$0a
		dc.b '%s [usage %d %s]',$0d,$0a
		dc.b '----------------------------------------',$0d,$0a
		dc.b 'keycode| click               | drag                | index               ',$0d,$0a
		dc.b '=======|=====================|=====================|=====================',$0d,$0a,0
x97fea:
...
x98007:
		dc.b $0d,$0a
		dc.b $09,$09,$09,' List of all named objects',$0d,$0a
		dc.b $09,$09,$09,' =========================',$0d,$0a
		dc.b $0d,$0a
		dc.b $0d,$0a
		dc.b $09,'Name',$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,' |Use |Size |',$09,' Name',$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,' |Use |Size |',$0d,$0a
		dc.b '===============================|====|=====|================================|====|=====|',0
x980e2:
		dc.b '%-31s|%4d|%5ld|',0
x980f2:
		...
		dc.b '=======================================================================================',$0d,$0a,0
x9814e:
		dc.b '%ld objects containing %ld bytes user data',$0d,$0a
		dc.b $0d,$0a,0
x9817d:
		dc.b '.LST',0
x98182:
