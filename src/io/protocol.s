...
[00014d40] 41f9 000f b02a            lea.l      iostring,a0
[00014d46] 4eb9 0007 5680            jsr        sprintf
[00014d4c] 4fef 000a                 lea.l      10(a7),a7
[00014d50] 41f9 000f b02a            lea.l      iostring,a0
[00014d56] 4eb9 0001 65f6            jsr        save_string
[00014d5c] 202e 000e                 move.l     14(a6),d0
[00014d60] 7238                      moveq.l    #56,d1
[00014d62] 4eb9 0007 769e            jsr        _uldiv
[00014d68] 2a00                      move.l     d0,d5
[00014d6a] 2c6e 0004                 movea.l    4(a6),a6
[00014d6e] 4246                      clr.w      d6
[00014d70] 6000 00b8                 bra        prot_clickdrag_7
prot_clickdrag_19:
...
[00014e08] 41f9 000f b02a            lea.l      iostring,a0
[00014e0e] 4eb9 0007 5680            jsr        sprintf
[00014e14] 4fef 0010                 lea.l      16(a7),a7
[00014e18] 41f9 000f b02a            lea.l      iostring,a0
[00014e1e] 4eb9 0001 65f6            jsr        save_string
prot_clickdrag_18:
[00014e24] 4dee 0038                 lea.l      56(a6),a6
[00014e28] 5246                      addq.w     #1,d6
prot_clickdrag_7:
[00014e2a] ba46                      cmp.w      d6,d5
[00014e2c] 6e00 ff46                 bgt        prot_clickdrag_19
[00014e30] 41f9 0009 7ed7            lea.l      $00097ED7,a0
[00014e36] 4eb9 0001 65f6            jsr        save_string
[00014e3c] 5244                      addq.w     #1,d4
prot_clickdrag_2:
[00014e3e] b644                      cmp.w      d4,d3
[00014e40] 6e00 fe72                 bgt        prot_clickdrag_20
[00014e44] 41f9 0009 7eda            lea.l      $00097EDA,a0
[00014e4a] 4eb9 0001 65f6            jsr        save_string
prot_clickdrag_1:
...
[00014e6a] 4eb9 0001 800e            jsr        info_list
[00014e70] 41ea 0137                 lea.l      311(a2),a0
[00014e74] 4eb9 0001 8066            jsr        info_obj
[00014e7a] 41ea 013b                 lea.l      315(a2),a0
[00014e7e] 4eb9 0001 65f6            jsr        save_string
[00014e84] 7600                      moveq.l    #0,d3
[00014e86] 2803                      move.l     d3,d4
[00014e88] 266b 0010                 movea.l    16(a3),a3
[00014e8c] 49f9 000f b02a            lea.l      iostring,a4
[00014e92] 6048                      bra.s      prot_labellist_1
prot_labellist_4:
[00014e94] 7001                      moveq.l    #1,d0
[00014e96] c084                      and.l      d4,d0
[00014e98] 670c                      beq.s      prot_labellist_2
[00014e9a] 41ea 0032                 lea.l      50(a2),a0
[00014e9e] 4eb9 0001 65f6            jsr        save_string
[00014ea4] 600a                      bra.s      prot_labellist_3
prot_labellist_2:
[00014ea6] 41ea 000b                 lea.l      11(a2),a0
[00014eaa] 4eb9 0001 65f6            jsr        save_string
prot_labellist_3:
...
[00014f1a] 4eb9 0007 6950            jsr        strcpy
[00014f20] 702e                      moveq.l    #46,d0
[00014f22] 41d7                      lea.l      (a7),a0
[00014f24] 4eb9 0007 68e2            jsr        strrchr
...
[00014f6a] 6000 00be                 bra        protocol_2
protocol_1:
[00014f6e] 4215                      clr.b      (a5)
[00014f70] 41d7                      lea.l      (a7),a0
[00014f72] 4eb9 0001 7ec6            jsr        info_start
[00014f78] 41ec 02b6                 lea.l      694(a4),a0
[00014f7c] 4eb9 0001 7faa            jsr        info_title
[00014f82] 3003                      move.w     d3,d0
[00014f84] 4eb9 0001 653e            jsr        set_handle
[00014f8a] 4eb9 0007 5162            jsr        setjmp
[00014f90] 4a40                      tst.w      d0
[00014f92] 6712                      beq.s      protocol_3
...
[00014fa4] 6076                      bra.s      protocol_4
protocol_3:
[00014fa6] 91c8                      suba.l     a0,a0
[00014fa8] 4eb9 0007 539e            jsr        time
[00014fae] 2f40 0080                 move.l     d0,128(a7)
[00014fb2] 4bf9 000f b02a            lea.l      iostring,a5
[00014fb8] 2f2a 0008                 move.l     8(a2),-(a7)
[00014fbc] 41ef 0084                 lea.l      132(a7),a0
[00014fc0] 4eb9 0007 531e            jsr        ctime
[00014fc6] 2f08                      move.l     a0,-(a7)
[00014fc8] 43f9 0009 82c6            lea.l      pc_welcome,a1
[00014fce] 204d                      movea.l    a5,a0
[00014fd0] 4eb9 0007 5680            jsr        sprintf
[00014fd6] 504f                      addq.w     #8,a7
[00014fd8] 204d                      movea.l    a5,a0
[00014fda] 4eb9 0001 65f6            jsr        save_string
[00014fe0] 206a 001c                 movea.l    28(a2),a0
[00014fe4] 6100 fc82                 bsr        prot_clickdrag
[00014fe8] 206a 0020                 movea.l    32(a2),a0
[00014fec] 6100 fc7a                 bsr        prot_clickdrag
[00014ff0] 206a 0018                 movea.l    24(a2),a0
[00014ff4] 6100 fc72                 bsr        prot_clickdrag
[00014ff8] 43ec 02c0                 lea.l      704(a4),a1
[00014ffc] 206a 0034                 movea.l    52(a2),a0
[00015000] 6100 fb8e                 bsr        prot_texte
[00015004] 43ec 02d5                 lea.l      725(a4),a1
[00015008] 206a 0024                 movea.l    36(a2),a0
[0001500c] 6100 fb82                 bsr        prot_texte
[00015010] 204a                      movea.l    a2,a0
[00015012] 6100 fe46                 bsr        prot_labellist
[00015016] 4eb9 0001 660a            jsr        close_buf
protocol_4:
[0001501c] 4eb9 0001 7f8a            jsr        info_end
[00015022] 3003                      move.w     d3,d0
[00015024] 4eb9 0007 29ae            jsr        Fclose
protocol_2:
...
[00097ed3]                           dc.b $22
[00097ed4]                           dc.w $5c00
[00097ed6]                           dc.b '"',$0d,$0a,0
[00097eda]                           dc.b $0d,$0a,$0d,$0a,0
[00097edf]                           dc.b $0d,$0a,'====================',$0d,$0a,$0d,$0a,0
[00097efa]                           dc.b 'free ',0
[00097f00]                           dc.b 'extern ',0
[00097f08]                           dc.b 'local',0
[00097f0e]                           dc.b 'global',0
[00097f15]                           dc.b $0d,$0a,'%s [usage %d %s]',$0d,$0a,'----------------------------------------',$0d,$0a,'keycode| click               | drag                | index               ',$0d,$0a,'=======|=====================|=====================|=====================',$0d,$0a,0
[00097fea]                           dc.b '%-7s|%-21s|%-21s|%-21s',$0d,$0a,0
[00098003]                           dc.b 'all',0
[00098007]                           dc.b $0d,$0a,$09,$09,$09,' List of all named objects',$0d,$0a,$09,$09,$09,' =========================',$0d,$0a,$0d,$0a,$0d,$0a,$09,'Name',$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,' |Use |Size |',$09,' Name',$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,$09,' |Use |Size |',$0d,$0a,'===============================|====|=====|================================|====|=====|',0
[000980e2]                           dc.b '%-31s|%4d|%5ld|',0
[000980f2]                           dc.b $0d,$0a,'=======================================================================================',$0d,$0a,0
[0009814e]                           dc.b '%ld objects containing %ld bytes user data',$0d,$0a,$0d,$0a,0
[0009817d]                           dc.b '.LST',0
[00098182]                           dc.b 'Protokoll',0
[0009818c]                           dc.b $09,$09,'TEXTS',$0d,$0a,$09,$09,'=====',$0d,$0a,$0d,$0a,0
[000981a1]                           dc.b $09,$09,'ALERTBOXES',$0d,$0a,$09,$09,'==========',$0d,$0a,$0d,$0a,0
