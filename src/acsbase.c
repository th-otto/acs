...
static const char *const regscheck[] = {
	"\tDie Zahlung erfolgt per beiliegendem Scheck ber 50,- EUR.",
	"",
	NULL
};

static const char *const regkonto[] = {
	"\tDen Betrag von 50,- EUR berweise ich vorab - unter Angabe obigen Namens -",
	"\tauf das Konto:",
	"",
	"\t\tMartin Els„sser",
	"\t\tPostbank Mnchen",
...
static const char *const reginn[] = {
	"\tIch zahle den Betrag von 53,- DM per Inland-Nachnahme.", /* BUG: should be EUR */
	"",
	NULL
};

static const char *const regonn[] = {
	"\tIch zahle den Betrag von 63,- DM per Ausland-Nachnahme.", /* BUG: should be EUR */
	"",
	NULL
};
