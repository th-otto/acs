...
[0004425a] 6f00 007e                 ble.w      $000442DA
[0004425e] 47f9 0010 4652            lea.l      $00104652,a3
[00044264] 7001                      moveq.l    #1,d0
[00044266] c043                      and.w      d3,d0
[00044268] 671c                      beq.s      $00044286
[0004426a] 0c53 aaaa                 cmpi.w     #$AAAA,(a3)
[0004426e] 6730                      beq.s      $000442A0
...
[0004427e] 4eb9 0006 4e48            jsr        $00064E48
[00044284] 601a                      bra.s      $000442A0
[00044286] 0c53 5555                 cmpi.w     #$5555,(a3)
[0004428a] 6714                      beq.s      $000442A0
...
[0004429a] 4eb9 0006 4e48            jsr        $00064E48
...
[000442fa] 6f00 0082                 ble        $0004437E
[000442fe] 47f9 0010 4652            lea.l      $00104652,a3
[00044304] 3004                      move.w     d4,d0
[00044306] b740                      eor.w      d3,d0
[00044308] c07c 0001                 and.w      #$0001,d0
[0004430c] 671c                      beq.s      $0004432A
[0004430e] 0c53 aaaa                 cmpi.w     #$AAAA,(a3)
[00044312] 6730                      beq.s      $00044344
...
[00044322] 4eb9 0006 4e48            jsr        $00064E48
[00044328] 601a                      bra.s      $00044344
[0004432a] 0c53 5555                 cmpi.w     #$5555,(a3)
[0004432e] 6714                      beq.s      $00044344
...
[0004433e] 4eb9 0006 4e48            jsr        $00064E48
...
[0004439e] 6f00 007e                 ble.w      $0004441E
[000443a2] 47f9 0010 4652            lea.l      $00104652,a3
[000443a8] 7001                      moveq.l    #1,d0
[000443aa] c043                      and.w      d3,d0
[000443ac] 671c                      beq.s      $000443CA
[000443ae] 0c53 5555                 cmpi.w     #$5555,(a3)
[000443b2] 6730                      beq.s      $000443E4
...
[000443c2] 4eb9 0006 4e48            jsr        $00064E48
[000443c8] 601a                      bra.s      $000443E4
[000443ca] 0c53 aaaa                 cmpi.w     #$AAAA,(a3)
[000443ce] 6714                      beq.s      $000443E4
...
[000443de] 4eb9 0006 4e48            jsr        $00064E48
...
[0004443e] 6f00 0082                 ble        $000444C2
[00044442] 47f9 0010 4652            lea.l      $00104652,a3
[00044448] 3004                      move.w     d4,d0
[0004444a] b740                      eor.w      d3,d0
[0004444c] c07c 0001                 and.w      #$0001,d0
[00044450] 671c                      beq.s      $0004446E
[00044452] 0c53 5555                 cmpi.w     #$5555,(a3)
[00044456] 6730                      beq.s      $00044488
...
[00044466] 4eb9 0006 4e48            jsr        $00064E48
[0004446c] 601a                      bra.s      $00044488
[0004446e] 0c53 aaaa                 cmpi.w     #$AAAA,(a3)
[00044472] 6714                      beq.s      $00044488
...
[00044482] 4eb9 0006 4e48            jsr        $00064E48
...
[000444d6] 45f9 0010 4654            lea.l      $00104654,a2
[000444dc] 6000 014e                 bra        $0004462C
[000444e0] b67c 0200                 cmp.w      #$0200,d3
[000444e4] 6c00 0154                 bge        $0004463A
...
[00044566] 6706                      beq.s      $0004456E
[00044568] b07c 0021                 cmp.w      #$0021,d0
[0004456c] 6674                      bne.s      $000445E2
...
[00044636] 6d00 fea8                 blt        $000444E0
...
[000446a8] 4eb9 0006 3f60            jsr        $00063F60
[000446ae] 2279 000d 99d6            movea.l    $000D99D6,a1
[000446b4] 91c8                      suba.l     a0,a0
[000446b6] 303c 0100                 move.w     #$0100,d0
[000446ba] 4eb9 0006 c914            jsr        $0006C914
[000446c0] 49f9 0010 4654            lea.l      $00104654,a4
[000446c6] 4243                      clr.w      d3
[000446c8] 3943 fffe                 move.w     d3,-2(a4)
[000446cc] 6000 0138                 bra        $00044806
[000446d0] b67c 0200                 cmp.w      #$0200,d3
[000446d4] 6c00 013a                 bge        $00044810
[000446d8] 3003                      move.w     d3,d0
[000446da] e948                      lsl.w      #4,d0
[000446dc] 0c74 0001 000e            cmpi.w     #$0001,14(a4,d0.w)
[000446e2] 6600 00c6                 bne        $000447AA
...
[00044960] 6000 00aa                 bra        $00044A0C
[00044964] b655                      cmp.w      (a5),d3
[00044966] 6600 00a0                 bne        $00044A08
...
[000449aa] 49f9 0010 4654            lea.l      $00104654,a4
[000449b0] d8c0                      adda.w     d0,a4
[000449b2] 5344                      subq.w     #1,d4
[000449b4] 603a                      bra.s      $000449F0
...
[00044a36] 6f00 008c                 ble        $00044AC4
[00044a3a] 2668 0240                 movea.l    576(a0),a3
[00044a3e] 4243                      clr.w      d3
[00044a40] 6064                      bra.s      $00044AA6
...
[00044afa] 6b00 01d0                 bmi        $00044CCC
[00044afe] 6000 01c4                 bra        $00044CC4
...
[00044b40] 6706                      beq.s      $00044B48
[00044b42] be7c 0021                 cmp.w      #$0021,d7
[00044b46] 6650                      bne.s      $00044B98
...
[00044c58] 6748                      beq.s      $00044CA2
[00044c5a] 2a2a 0014                 move.l     20(a2),d5
[00044c5e] 6722                      beq.s      $00044C82
[00044c60] 4247                      clr.w      d7
[00044c62] 6018                      bra.s      $00044C7C
...
[00044ce6] 2079 000d 99d6            movea.l    $000D99D6,a0
[00044cec] 4eb9 0006 d54c            jsr        $0006D54C
[00044cf2] 4eb9 0004 e5ea            jsr        $0004E5EA
[00044cf8] 2448                      movea.l    a0,a2
[00044cfa] 200a                      move.l     a2,d0
[00044cfc] 6700 0620                 beq        $0004531E
...
[00044d0e] 660e                      bne.s      $00044D1E
[00044d10] 6100 fd14                 bsr        $00044A26
[00044d14] 42af 0014                 clr.l      20(a7)
[00044d18] 426f 0028                 clr.w      40(a7)
[00044d1c] 6050                      bra.s      $00044D6E
...
[00044d32] 6700 05ea                 beq        $0004531E
...
[00044d42] 4eb9 0007 712e            jsr        $0007712E
...
[00044d5a] 4eb9 0007 6f44            jsr        $00076F44
...
[00044d90] 6706                      beq.s      $00044D98
[00044d92] ba6a 0036                 cmp.w      54(a2),d5
[00044d96] 6d06                      blt.s      $00044D9E
[00044d98] 426f 0026                 clr.w      38(a7)
[00044d9c] 6018                      bra.s      $00044DB6
...
[00044dfe] 4eb9 0004 9898            jsr        $00049898
[00044e04] 7003                      moveq.l    #3,d0
[00044e06] 4eb9 0005 1e1c            jsr        $00051E1C
[00044e0c] 4eb9 0004 9970            jsr        $00049970
[00044e12] 7203                      moveq.l    #3,d1
[00044e14] 2053                      movea.l    (a3),a0
[00044e16] 3028 0010                 move.w     16(a0),d0
[00044e1a] 4eb9 0006 4da0            jsr        $00064DA0
...
[00044e30] 6100 f410                 bsr        $00044242
[00044e34] ba55                      cmp.w      (a5),d5
[00044e36] 6714                      beq.s      $00044E4C
...
[00044f24] 6c02                      bge.s      $00044F28
[00044f26] 6006                      bra.s      $00044F2E
...
[00044fda] 4eb9 0007 773a            jsr        $0007773A
...
[0004503a] 6f00 00c2                 ble        $000450FE
[0004503e] b644                      cmp.w      d4,d3
[00045040] 6f00 00bc                 ble        $000450FE
[00045044] 322a 0022                 move.w     34(a2),d1
[00045048] c27c 0140                 and.w      #$0140,d1
[0004504c] 6700 00b0                 beq        $000450FE
...
[000450a2] 4eb9 0007 773a            jsr        $0007773A
...
[0004510e] 6c00 009a                 bge        $000451AA
[00045112] bc43                      cmp.w      d3,d6
[00045114] 6f00 0094                 ble        $000451AA
[00045118] 302a 0022                 move.w     34(a2),d0
[0004511c] c07c 0c00                 and.w      #$0C00,d0
[00045120] 6700 0088                 beq        $000451AA
...
[00045178] 4eb9 0007 773a            jsr        $0007773A
...
[000451ba] 6c00 009c                 bge        $00045258
[000451be] b843                      cmp.w      d3,d4
[000451c0] 6f00 0096                 ble        $00045258
[000451c4] 302a 0022                 move.w     34(a2),d0
[000451c8] c07c 0180                 and.w      #$0180,d0
[000451cc] 6700 008a                 beq        $00045258
...
[00045224] 4eb9 0007 773a            jsr        $0007773A
...
[00045272] 4eb9 0005 f94a            jsr        $0005F94A
[00045278] 302f 0026                 move.w     38(a7),d0
[0004527c] 6722                      beq.s      $000452A0
...
[00045298] 6100 f830                 bsr        $00044ACA
[0004529c] 504f                      addq.w     #8,a7
[0004529e] 6024                      bra.s      $000452C4
...
[000452e8] 6600 fb22                 bne        $00044E0C
[000452ec] 7002                      moveq.l    #2,d0
[000452ee] 4eb9 0005 1e1c            jsr        $00051E1C
...
[00045354] 6600 00b4                 bne        $0004540A
[00045358] 7408                      moveq.l    #8,d2
[0004535a] c46b 000a                 and.w      10(a3),d2
[0004535e] 6600 00aa                 bne        $0004540A
...
[00045372] 6706                      beq.s      $0004537A
[00045374] b07c 0021                 cmp.w      #$0021,d0
[00045378] 666a                      bne.s      $000453E4
...
[000453c8] 4eb9 0005 ef64            jsr        $0005EF64
[000453ce] 4a40                      tst.w      d0
[000453d0] 663c                      bne.s      $0004540E
[000453d2] 3207                      move.w     d7,d1
[000453d4] 3006                      move.w     d6,d0
[000453d6] 41d7                      lea.l      (a7),a0
[000453d8] 4eb9 0005 ef64            jsr        $0005EF64
[000453de] 4a40                      tst.w      d0
[000453e0] 662c                      bne.s      $0004540E
[000453e2] 6026                      bra.s      $0004540A
...
[00045400] 4eb9 0005 ef64            jsr        $0005EF64
[00045406] 4a40                      tst.w      d0
[00045408] 6604                      bne.s      $0004540E
[0004540a] 70ff                      moveq.l    #-1,d0
[0004540c] 6050                      bra.s      $0004545E
[0004540e] 382b 0002                 move.w     2(a3),d4
[00045412] 4a44                      tst.w      d4
[00045414] 6b46                      bmi.s      $0004545C
[00045416] 302f 0010                 move.w     16(a7),d0
[0004541a] 6f40                      ble.s      $0004545C
...
[00045434] 6100 fef2                 bsr        $00045328
[00045438] 544f                      addq.w     #2,a7
[0004543a] 4a40                      tst.w      d0
[0004543c] 6b02                      bmi.s      $00045440
...
[00045452] 66d2                      bne.s      $00045426
[00045454] 4a45                      tst.w      d5
[00045456] 6b04                      bmi.s      $0004545C
[00045458] 3005                      move.w     d5,d0
[0004545a] 6002                      bra.s      $0004545E
...
[000454c0] 6100 fe66                 bsr        $00045328
...
[00045536] 4eb9 0007 69b0            jsr        $000769B0
[0004553c] 2f00                      move.l     d0,-(a7)
[0004553e] 204b                      movea.l    a3,a0
[00045540] 4eb9 0007 69b0            jsr        $000769B0
[00045546] b09f                      cmp.l      (a7)+,d0
[00045548] 640a                      bcc.s      $00045554
[0004554a] 204b                      movea.l    a3,a0
[0004554c] 4eb9 0007 69b0            jsr        $000769B0
[00045552] 600a                      bra.s      $0004555E
[00045554] 206a 0008                 movea.l    8(a2),a0
[00045558] 4eb9 0007 69b0            jsr        $000769B0
[0004555e] 226a 0008                 movea.l    8(a2),a1
[00045562] 204b                      movea.l    a3,a0
[00045564] 4eb9 0007 69fc            jsr        $000769FC
[0004556a] 4a40                      tst.w      d0
[0004556c] 6604                      bne.s      $00045572
...
[00045616] 6100 eeb2                 bsr        $000444CA
...
[00045686] 4eb9 0004 9898            jsr        $00049898
...
[0004570c] 4eb9 0004 9898            jsr        $00049898
...
[00045942] 6b00 008a                 bmi        $000459CE
[00045946] 3006                      move.w     d6,d0
[00045948] c07c 1000                 and.w      #$1000,d0
[0004594c] 6718                      beq.s      $00045966
...
[00045a3a] 6700 00ae                 beq        $00045AEA
[00045a3e] 2e2a 0004                 move.l     4(a2),d7
[00045a42] 6700 00a6                 beq        $00045AEA
...
[00045a7a] 4eb9 0005 f4e8            jsr        $0005F4E8
...
[00045aca] 4eb9 0004 9902            jsr        $00049902
[00045ad0] 206a 0004                 movea.l    4(a2),a0
[00045ad4] 4e90                      jsr        (a0)
[00045ad6] 4eb9 0004 9940            jsr        $00049940
[00045adc] 41ef 0044                 lea.l      68(a7),a0
[00045ae0] 4eb9 0005 f532            jsr        $0005F532
[00045ae6] 6000 00ca                 bra        $00045BB2
...
[00045b0c] 6700 00a0                 beq        $00045BAE
[00045b10] 6100 ed2e                 bsr        $00044840
[00045b14] 6100 ed36                 bsr        $0004484C
[00045b18] 3c00                      move.w     d0,d6
[00045b1a] 6f00 0092                 ble        $00045BAE
[00045b1e] c07c 1000                 and.w      #$1000,d0
[00045b22] 6724                      beq.s      $00045B48
...
[00045b6e] 670e                      beq.s      $00045B7E
[00045b70] 907c 0009                 sub.w      #$0009,d0
[00045b74] 6708                      beq.s      $00045B7E
[00045b76] 907c 000b                 sub.w      #$000B,d0
[00045b7a] 6702                      beq.s      $00045B7E
[00045b7c] 6030                      bra.s      $00045BAE
[00045b7e] 202a 000c                 move.l     12(a2),d0
[00045b82] 672a                      beq.s      $00045BAE
...
[00045bbe] 6706                      beq.s      $00045BC6
[00045bc0] b3e8 0018                 cmpa.l     24(a0),a1
[00045bc4] 6636                      bne.s      $00045BFC
...
[00045c24] 4eb9 0004 ad60            jsr        $0004AD60
[00045c2a] 6000 06f4                 bra        $00046320
[00045c2e] 4a44                      tst.w      d4
[00045c30] 6700 06ee                 beq        $00046320
[00045c34] 3f7c ffff 0034            move.w     #$FFFF,52(a7)
[00045c3a] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[00045ca4] 487a f828                 pea.l      $000454CE(pc)
[00045ca8] 42a7                      clr.l      -(a7)
[00045caa] 43ef 016c                 lea.l      364(a7),a1
[00045cae] 2879 000d 2c54            movea.l    $000D2C54,a4
[00045cb4] 286c 0040                 movea.l    64(a4),a4
[00045cb8] 2079 000d 2c54            movea.l    $000D2C54,a0
...
[00045ccc] 4eb9 0004 3a92            jsr        $00043A92
[00045cd2] 4a40                      tst.w      d0
[00045cd4] 6658                      bne.s      $00045D2E
[00045cd6] 41ef 005c                 lea.l      92(a7),a0
[00045cda] 4eb9 0007 69b0            jsr        $000769B0
...
[00045d04] 4eb9 0005 c7dc            jsr        $0005C7DC
[00045d0a] 584f                      addq.w     #4,a7
[00045d0c] 2848                      movea.l    a0,a4
[00045d0e] 200c                      move.l     a4,d0
[00045d10] 671c                      beq.s      $00045D2E
[00045d12] 487a f816                 pea.l      $0004552A(pc)
[00045d16] 224c                      movea.l    a4,a1
[00045d18] 2079 000d 2c54            movea.l    $000D2C54,a0
...
[00045d32] 6b00 05d4                 bmi        $00046308
...
[00045d46] 51c8 fffc                 dbf        d0,$00045D44
...
[00045e0c] 2279 000d 99d6            movea.l    $000D99D6,a1
[00045e12] 204c                      movea.l    a4,a0
[00045e14] 302f 0034                 move.w     52(a7),d0
[00045e18] 7210                      moveq.l    #16,d1
[00045e1a] 4eb9 0006 a818            jsr        $0006A818
[00045e20] 4a40                      tst.w      d0
[00045e22] 6700 01e6                 beq        $0004600A
...
[0004607c] 6700 012a                 beq        $000461A8
[00046080] 5340                      subq.w     #1,d0
[00046082] 6710                      beq.s      $00046094
[00046084] 907c 0009                 sub.w      #$0009,d0
[00046088] 670a                      beq.s      $00046094
[0004608a] 907c 000b                 sub.w      #$000B,d0
[0004608e] 6704                      beq.s      $00046094
[00046090] 6000 026a                 bra        $000462FC
[00046094] 206a 000c                 movea.l    12(a2),a0
[00046098] 4eb9 0007 69b0            jsr        $000769B0
[0004609e] 5280                      addq.l     #1,d0
[000460a0] 4eb9 0004 7f44            jsr        $00047F44
[000460a6] 2f48 01e0                 move.l     a0,480(a7)
[000460aa] 2008                      move.l     a0,d0
[000460ac] 6700 024e                 beq        $000462FC
[000460b0] 226a 000c                 movea.l    12(a2),a1
[000460b4] 4eb9 0007 6950            jsr        $00076950
[000460ba] 7210                      moveq.l    #16,d1
[000460bc] 4240                      clr.w      d0
[000460be] 204c                      movea.l    a4,a0
[000460c0] 4eb9 0007 712e            jsr        $0007712E
...
[000460de] 4eb9 0005 1e1c            jsr        $00051E1C
[000460e4] 4eb9 0004 6d70            jsr        $00046D70
[000460ea] 2279 000d 99d6            movea.l    $000D99D6,a1
[000460f0] 204c                      movea.l    a4,a0
[000460f2] 7210                      moveq.l    #16,d1
[000460f4] 302f 0034                 move.w     52(a7),d0
[000460f8] 4eb9 0006 a818            jsr        $0006A818
[000460fe] 7210                      moveq.l    #16,d1
[00046100] 4240                      clr.w      d0
[00046102] 204c                      movea.l    a4,a0
[00046104] 4eb9 0007 712e            jsr        $0007712E
[0004610a] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[0004622c] 4eb9 0005 1e1c            jsr        $00051E1C
[00046232] 4eb9 0004 6d70            jsr        $00046D70
[00046238] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004623e] 204c                      movea.l    a4,a0
[00046240] 7210                      moveq.l    #16,d1
[00046242] 302f 0034                 move.w     52(a7),d0
[00046246] 4eb9 0006 a818            jsr        $0006A818
[0004624c] 7210                      moveq.l    #16,d1
[0004624e] 4240                      clr.w      d0
[00046250] 204c                      movea.l    a4,a0
[00046252] 4eb9 0007 712e            jsr        $0007712E
[00046258] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
