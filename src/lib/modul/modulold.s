...
[0006339e] 6600 00ba                 bne        $0006345A
[000633a2] 322a 000a                 move.w     10(a2),d1
[000633a6] c27c 2000                 and.w      #$2000,d1
[000633aa] 6600 00ae                 bne        $0006345A
[000633ae] 142a 0007                 move.b     7(a2),d2
[000633b2] 4882                      ext.w      d2
[000633b4] 947c 0015                 sub.w      #$0015,d2
[000633b8] b47c 000c                 cmp.w      #$000C,d2
[000633bc] 6200 0094                 bhi        $00063452
[000633c0] d442                      add.w      d2,d2
[000633c2] 343b 2006                 move.w     $000633CA(pc,d2.w),d2
[000633c6] 4efb 2002                 jmp        $000633CA(pc,d2.w)
J60:
[000633ca] 001a                      dc.w $001a   ; $000633e4-$000633ca
[000633cc] 001a                      dc.w $001a   ; $000633e4-$000633ca
[000633ce] 0054                      dc.w $0054   ; $0006341e-$000633ca
[000633d0] 002c                      dc.w $002c   ; $000633f6-$000633ca
[000633d2] 0088                      dc.w $0088   ; $00063452-$000633ca
[000633d4] 0078                      dc.w $0078   ; $00063442-$000633ca
[000633d6] 0088                      dc.w $0088   ; $00063452-$000633ca
[000633d8] 0078                      dc.w $0078   ; $00063442-$000633ca
[000633da] 001a                      dc.w $001a   ; $000633e4-$000633ca
[000633dc] 001a                      dc.w $001a   ; $000633e4-$000633ca
[000633de] 0066                      dc.w $0066   ; $00063430-$000633ca
[000633e0] 0078                      dc.w $0078   ; $00063442-$000633ca
[000633e2] 0066                      dc.w $0066   ; $00063430-$000633ca
[000633e4] 206a 000c                 movea.l    12(a2),a0
[000633e8] 4eb9 0004 a146            jsr        $0004A146
[000633ee] 2a48                      movea.l    a0,a5
[000633f0] 2548 000c                 move.l     a0,12(a2)
[000633f4] 605c                      bra.s      $00063452
[000633f6] 206a 000c                 movea.l    12(a2),a0
[000633fa] 6100 ff1a                 bsr        $00063316
...
[00063490] 4eb9 0007 6f44            jsr        $00076F44
[00063496] 257c 0005 0f9c 008e       move.l     #$00050F9C,142(a2)
[0006349e] 257c 0005 117c 0092       move.l     #$0005117C,146(a2)
[000634a6] 257c 0005 2328 0096       move.l     #$00052328,150(a2)
...
[000634c6] 6716                      beq.s      $000634DE
[000634c8] 2040                      movea.l    d0,a0
[000634ca] 6100 fe8a                 bsr        $00063356
[000634ce] 2548 0014                 move.l     a0,20(a2)
[000634d2] 2008                      move.l     a0,d0
[000634d4] 6700 007a                 beq.w      $00063550
[000634d8] 4eb9 0004 a25e            jsr        $0004A25E
[000634de] 202a 0018                 move.l     24(a2),d0
[000634e2] 6714                      beq.s      $000634F8
[000634e4] 2040                      movea.l    d0,a0
[000634e6] 6100 fe6e                 bsr        $00063356
[000634ea] 2548 0018                 move.l     a0,24(a2)
[000634ee] 2008                      move.l     a0,d0
[000634f0] 6754                      beq.s      $00063546
[000634f2] 4eb9 0004 a25e            jsr        $0004A25E
[000634f8] 202a 005e                 move.l     94(a2),d0
[000634fc] 671e                      beq.s      $0006351C
[000634fe] 2040                      movea.l    d0,a0
[00063500] 6100 fe54                 bsr        $00063356
[00063504] 2548 005e                 move.l     a0,94(a2)
[00063508] 2008                      move.l     a0,d0
[0006350a] 6730                      beq.s      $0006353C
[0006350c] 4eb9 0004 a25e            jsr        $0004A25E
[00063512] 206a 005e                 movea.l    94(a2),a0
[00063516] 4eb9 0004 975e            jsr        $0004975E
[0006351c] 202a 005a                 move.l     90(a2),d0
[00063520] 673a                      beq.s      $0006355C
[00063522] 2040                      movea.l    d0,a0
[00063524] 4eb9 0004 9e38            jsr        $00049E38
[0006352a] 2548 005a                 move.l     a0,90(a2)
[0006352e] 2008                      move.l     a0,d0
[00063530] 662a                      bne.s      $0006355C
[00063532] 206a 005e                 movea.l    94(a2),a0
[00063536] 4eb9 0004 9b7c            jsr        $00049B7C
[0006353c] 206a 0018                 movea.l    24(a2),a0
[00063540] 4eb9 0004 9b7c            jsr        $00049B7C
[00063546] 206a 0014                 movea.l    20(a2),a0
[0006354a] 4eb9 0004 9b7c            jsr        $00049B7C
[00063550] 204a                      movea.l    a2,a0
[00063552] 4eb9 0004 7e26            jsr        $00047E26
[00063558] 6000 00f0                 bra        $0006364A
[0006355c] 204a                      movea.l    a2,a0
[0006355e] 4eb9 0004 b5cc            jsr        $0004B5CC
[00063564] 202a 004a                 move.l     74(a2),d0
[00063568] 670c                      beq.s      $00063576
...
[000635a0] 47f9 0010 6fea            lea.l      $00106FEA,a3
[000635a6] 4bf9 000d 3dc8            lea.l      $000D3DC8,a5
[000635ac] 49f9 0010 1f12            lea.l      ACSblk,a4
[000635b2] 6000 007a                 bra.w      $0006362E
[000635b6] 3003                      move.w     d3,d0
[000635b8] e548                      lsl.w      #2,d0
[000635ba] 2233 0000                 move.l     0(a3,d0.w),d1
[000635be] 666c                      bne.s      $0006362C
[000635c0] b679 0010 75ee            cmp.w      $001075EE,d3
[000635c6] 6f06                      ble.s      $000635CE
[000635c8] 33c3 0010 75ee            move.w     d3,$001075EE
[000635ce] 3003                      move.w     d3,d0
[000635d0] e548                      lsl.w      #2,d0
[000635d2] 278a 0000                 move.l     a2,0(a3,d0.w)
[000635d6] 2215                      move.l     (a5),d1
[000635d8] 6716                      beq.s      $000635F0
[000635da] 7401                      moveq.l    #1,d2
[000635dc] c46a 0054                 and.w      84(a2),d2
[000635e0] 670e                      beq.s      $000635F0
...
[0006362a] 6020                      bra.s      $0006364C
[0006362c] 5243                      addq.w     #1,d3
[0006362e] b67c 0100                 cmp.w      #$0100,d3
[00063632] 6d00 ff82                 blt.w      $000635B6
[00063636] 2279 000d 99d6            movea.l    $000D99D6,a1
[0006363c] 41f9 000c 97b8            lea.l      $000C97B8,a0
[00063642] 7001                      moveq.l    #1,d0
[00063644] 4eb9 0006 be76            jsr        $0006BE76
[0006364a] 91c8                      suba.l     a0,a0
[0006364c] 4cdf 7c08                 movem.l    (a7)+,d3/a2-a6
[00063650] 4e75                      rts
Awi_arrowed23x:
[00063652] 7201                      moveq.l    #1,d1
[00063654] 4eb9 0004 bcc8            jsr        $0004BCC8
[0006365a] 4e75                      rts
Af_first230:
[0006365c] 93c9                      suba.l     a1,a1
[0006365e] 4eb9 0004 798a            jsr        $0004798A
[00063664] 4e75                      rts
Af_next230:
[00063666] 91c8                      suba.l     a0,a0
[00063668] 4eb9 0004 79c8            jsr        $000479C8
[0006366e] 4e75                      rts
