...
[0004e27c] 6f02                      ble.s      $0004E280
[0004e27e] 600a                      bra.s      $0004E28A
...
[0004e2d6] 41f9 000d 2a22            lea.l      $000D2A22,a0
[0004e2dc] 4eb9 0004 9a5c            jsr        $00049A5C
[0004e2e2] 2748 fff8                 move.l     a0,-8(a3)
[0004e2e6] 2008                      move.l     a0,d0
[0004e2e8] 671e                      beq.s      $0004E308
[0004e2ea] 4eb9 0004 a25e            jsr        $0004A25E
...
[0004e392] 671e                      beq.s      $0004E3B2
[0004e394] 2252                      movea.l    (a2),a1
[0004e396] 3229 0236                 move.w     566(a1),d1
[0004e39a] 6722                      beq.s      $0004E3BE
[0004e39c] 3429 0238                 move.w     568(a1),d2
[0004e3a0] 6714                      beq.s      $0004E3B6
[0004e3a2] 2028 0014                 move.l     20(a0),d0
[0004e3a6] 670e                      beq.s      $0004E3B6
[0004e3a8] 4eb9 0004 f69e            jsr        $0004F69E
[0004e3ae] 5240                      addq.w     #1,d0
[0004e3b0] 660c                      bne.s      $0004E3BE
[0004e3b2] 70ff                      moveq.l    #-1,d0
[0004e3b4] 600a                      bra.s      $0004E3C0
[0004e3b6] 2054                      movea.l    (a4),a0
[0004e3b8] 4eb9 0004 fffc            jsr        $0004FFFC
[0004e3be] 4240                      clr.w      d0
[0004e3c0] 4cdf 1c00                 movem.l    (a7)+,a2-a4
[0004e3c4] 4e75                      rts
TRwindow:
[0004e3c6] 48e7 103c                 movem.l    d3/a2-a5,-(a7)
[0004e3ca] 47f9 000d 3dc8            lea.l      $000D3DC8,a3
[0004e3d0] 536b ffd2                 subq.w     #1,-46(a3)
[0004e3d4] 6600 008e                 bne        $0004E464
[0004e3d8] 7001                      moveq.l    #1,d0
[0004e3da] 4eb9 0005 1e1c            jsr        $00051E1C
[0004e3e0] 49f9 0010 73ea            lea.l      $001073EA,a4
[0004e3e6] 362c 0204                 move.w     516(a4),d3
[0004e3ea] 6022                      bra.s      $0004E40E
...
[0004e3fa] 6710                      beq.s      $0004E40C
[0004e3fc] b293                      cmp.l      (a3),d1
[0004e3fe] 670c                      beq.s      $0004E40C
...
[0004e506] 4eb9 0004 9e38            jsr        $00049E38
...
[0004e522] 4eb9 0004 a34e            jsr        $0004A34E
...
[0004e536] 47f9 0010 73ea            lea.l      $001073EA,a3
[0004e53c] 302a 0020                 move.w     32(a2),d0
[0004e540] 6b0e                      bmi.s      $0004E550
[0004e542] b07c 0080                 cmp.w      #$0080,d0
[0004e546] 6c08                      bge.s      $0004E550
[0004e548] e548                      lsl.w      #2,d0
[0004e54a] 2233 0000                 move.l     0(a3,d0.w),d1
[0004e54e] 6604                      bne.s      $0004E554
[0004e550] 4240                      clr.w      d0
[0004e552] 6032                      bra.s      $0004E586
...
[0004e562] 4eb9 0004 a094            jsr        $0004A094
...
[0004e574] 4eb9 0004 8140            jsr        $00048140
...
[0004e5c6] 6714                      beq.s      $0004E5DC
[0004e5c8] 204b                      movea.l    a3,a0
[0004e5ca] 4eb9 0005 013e            jsr        $0005013E
...
[0004e638] 51c8 fffc                 dbf        d0,$0004E636
...
[0004e64c] 51c8 fffc                 dbf        d0,$0004E64A
[0004e650] 42af 0018                 clr.l      24(a7)
[0004e654] 2039 000d 3dac            move.l     $000D3DAC,d0
[0004e65a] 670e                      beq.s      $0004E66A
[0004e65c] 2040                      movea.l    d0,a0
[0004e65e] 4eb9 0004 7fa6            jsr        $00047FA6
[0004e664] 42b9 000d 3dac            clr.l      $000D3DAC
[0004e66a] 2039 000d 3da8            move.l     $000D3DA8,d0
[0004e670] 670e                      beq.s      $0004E680
[0004e672] 2040                      movea.l    d0,a0
[0004e674] 4eb9 0004 7fa6            jsr        $00047FA6
[0004e67a] 42b9 000d 3da8            clr.l      $000D3DA8
[0004e680] 4bf9 0010 1f12            lea.l      ACSblk,a5
[0004e686] 206f 034c                 movea.l    844(a7),a0
[0004e68a] 4eb9 0004 3a92            jsr        $00043A92
[0004e690] 4a40                      tst.w      d0
[0004e692] 6600 05f2                 bne        $0004EC86
...
[0004e7bc] 6704                      beq.s      $0004E7C2
[0004e7be] 3202                      move.w     d2,d1
[0004e7c0] 6002                      bra.s      $0004E7C4
...
[0004e7ce] 4eb9 0006 da26            jsr        $0006DA26
[0004e7d4] 584f                      addq.w     #4,a7
[0004e7d6] 48c0                      ext.l      d0
[0004e7d8] 6000 05ea                 bra        $0004EDC4
[0004e7dc] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[0004e7f4] 6704                      beq.s      $0004E7FA
[0004e7f6] 7201                      moveq.l    #1,d1
[0004e7f8] 6002                      bra.s      $0004E7FC
...
[0004e804] 4eb9 0006 da26            jsr        $0006DA26
[0004e80a] 584f                      addq.w     #4,a7
[0004e80c] 48c0                      ext.l      d0
[0004e80e] 6000 05b4                 bra        $0004EDC4
[0004e812] 4eb9 0004 b286            jsr        $0004B286
[0004e818] 4eb9 0004 98d8            jsr        $000498D8
[0004e81e] 2055                      movea.l    (a5),a0
[0004e820] 3028 0236                 move.w     566(a0),d0
[0004e824] 6700 03da                 beq        $0004EC00
[0004e828] 41d7                      lea.l      (a7),a0
[0004e82a] 4eb9 0005 f4e8            jsr        $0005F4E8
...
[0004e874] 672c                      beq.s      $0004E8A2
[0004e876] 38aa 0020                 move.w     32(a2),(a4)
[0004e87a] 3014                      move.w     (a4),d0
[0004e87c] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004e882] 4eb9 0006 d1ba            jsr        $0006D1BA
[0004e888] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004e88e] 3014                      move.w     (a4),d0
[0004e890] 4eb9 0006 d214            jsr        $0006D214
[0004e896] 357c ffff 0020            move.w     #$FFFF,32(a2)
[0004e89c] 4eb9 0004 6d70            jsr        $00046D70
[0004e8a2] 5243                      addq.w     #1,d3
[0004e8a4] b67c 0080                 cmp.w      #$0080,d3
[0004e8a8] 6dae                      blt.s      $0004E858
[0004e8aa] 2079 000d 3dc8            movea.l    $000D3DC8,a0
[0004e8b0] 3028 0020                 move.w     32(a0),d0
[0004e8b4] 6600 009c                 bne        $0004E952
[0004e8b8] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004e8be] 91c8                      suba.l     a0,a0
[0004e8c0] 4240                      clr.w      d0
[0004e8c2] 4eb9 0006 b362            jsr        $0006B362
[0004e8c8] 4267                      clr.w      -(a7)
[0004e8ca] 42a7                      clr.l      -(a7)
[0004e8cc] 720e                      moveq.l    #14,d1
[0004e8ce] 4240                      clr.w      d0
[0004e8d0] 4eb9 0007 1656            jsr        $00071656
[0004e8d6] 5c4f                      addq.w     #6,a7
[0004e8d8] 4a44                      tst.w      d4
[0004e8da] 6776                      beq.s      $0004E952
...
[0004e904] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004e90a] 4242                      clr.w      d2
[0004e90c] 7201                      moveq.l    #1,d1
[0004e90e] 41f9 000d 3dd0            lea.l      $000D3DD0,a0
[0004e914] 4240                      clr.w      d0
[0004e916] 4eb9 0006 b93c            jsr        $0006B93C
...
[0004e942] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004e948] 4eb9 0006 bde4            jsr        $0006BDE4
[0004e94e] 4fef 000c                 lea.l      12(a7),a7
[0004e952] 4eb9 0004 6d70            jsr        $00046D70
[0004e958] 4a44                      tst.w      d4
[0004e95a] 671c                      beq.s      $0004E978
[0004e95c] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[0004e970] 4eb9 0006 da26            jsr        $0006DA26
[0004e976] 584f                      addq.w     #4,a7
[0004e978] 7010                      moveq.l    #16,d0
[0004e97a] 4eb9 0005 1e1c            jsr        $00051E1C
[0004e980] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004e986] 4eb9 0006 aa82            jsr        $0006AA82
[0004e98c] 4a44                      tst.w      d4
[0004e98e] 671c                      beq.s      $0004E9AC
...
[0004ea18] 4eb9 0006 65ce            jsr        $000665CE
...
[0004eabc] 671c                      beq.s      $0004EADA
[0004eabe] 41f9 000d 3ff2            lea.l      $000D3FF2,a0
[0004eac4] 4eb9 0007 28d2            jsr        $000728D2
[0004eaca] 4eb9 0007 28c4            jsr        $000728C4
[0004ead0] 4a40                      tst.w      d0
[0004ead2] 67f6                      beq.s      $0004EACA
[0004ead4] 4eb9 0007 28b6            jsr        $000728B6
[0004eada] 202f 0018                 move.l     24(a7),d0
[0004eade] 6726                      beq.s      $0004EB06
...
[0004eaf4] 4eb9 0006 65ce            jsr        $000665CE
[0004eafa] 584f                      addq.w     #4,a7
[0004eafc] 206f 0018                 movea.l    24(a7),a0
[0004eb00] 4eb9 0004 d996            jsr        $0004D996
[0004eb06] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004eb0c] 91c8                      suba.l     a0,a0
[0004eb0e] 303c 0101                 move.w     #$0101,d0
[0004eb12] 4eb9 0006 c914            jsr        $0006C914
[0004eb18] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004eb1e] 4eb9 0006 d6c6            jsr        $0006D6C6
[0004eb24] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004eb2a] 4eb9 0006 aa82            jsr        $0006AA82
[0004eb30] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004eb36] 4eb9 0006 a74c            jsr        $0006A74C
[0004eb3c] 2055                      movea.l    (a5),a0
[0004eb3e] 3080                      move.w     d0,(a0)
[0004eb40] 7020                      moveq.l    #32,d0
[0004eb42] 4eb9 0005 1e1c            jsr        $00051E1C
[0004eb48] 4267                      clr.w      -(a7)
[0004eb4a] 42a7                      clr.l      -(a7)
[0004eb4c] 720e                      moveq.l    #14,d1
[0004eb4e] 4240                      clr.w      d0
[0004eb50] 4eb9 0007 1656            jsr        $00071656
[0004eb56] 5c4f                      addq.w     #6,a7
[0004eb58] 2479 000d 3dc8            movea.l    $000D3DC8,a2
[0004eb5e] 302a 0020                 move.w     32(a2),d0
[0004eb62] 665c                      bne.s      $0004EBC0
[0004eb64] 222a 0014                 move.l     20(a2),d1
[0004eb68] 6710                      beq.s      $0004EB7A
[0004eb6a] 4267                      clr.w      -(a7)
[0004eb6c] 2f01                      move.l     d1,-(a7)
[0004eb6e] 4240                      clr.w      d0
[0004eb70] 720e                      moveq.l    #14,d1
[0004eb72] 4eb9 0007 1656            jsr        $00071656
[0004eb78] 5c4f                      addq.w     #6,a7
[0004eb7a] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004eb80] 7001                      moveq.l    #1,d0
[0004eb82] 206a 005e                 movea.l    94(a2),a0
[0004eb86] 4eb9 0006 b362            jsr        $0006B362
...
[0004ebb0] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004ebb6] 4eb9 0006 bde4            jsr        $0006BDE4
[0004ebbc] 4fef 000c                 lea.l      12(a7),a7
[0004ebc0] 7601                      moveq.l    #1,d3
[0004ebc2] 601a                      bra.s      $0004EBDE
...
[0004ebe2] 6de0                      blt.s      $0004EBC4
[0004ebe4] 202f 0144                 move.l     324(a7),d0
[0004ebe8] 670a                      beq.s      $0004EBF4
...
[0004ebf6] 4eb9 0005 f532            jsr        $0005F532
[0004ebfc] 6000 01b2                 bra        $0004EDB0
...
[0004ec0e] 51c8 fffc                 dbf        d0,$0004EC0C
[0004ec12] 7c14                      moveq.l    #20,d6
[0004ec14] 97cb                      suba.l     a3,a3
[0004ec16] 6010                      bra.s      $0004EC28
[0004ec18] 7004                      moveq.l    #4,d0
[0004ec1a] c0ab 0002                 and.l      2(a3),d0
[0004ec1e] 6708                      beq.s      $0004EC28
[0004ec20] 7220                      moveq.l    #32,d1
[0004ec22] c26b 000c                 and.w      12(a3),d1
[0004ec26] 660e                      bne.s      $0004EC36
[0004ec28] 204b                      movea.l    a3,a0
[0004ec2a] 4eb9 0005 4250            jsr        $00054250
[0004ec30] 2648                      movea.l    a0,a3
[0004ec32] 200b                      move.l     a3,d0
[0004ec34] 66e2                      bne.s      $0004EC18
[0004ec36] 200b                      move.l     a3,d0
[0004ec38] 674c                      beq.s      $0004EC86
[0004ec3a] 206f 034c                 movea.l    844(a7),a0
[0004ec3e] 4eb9 0007 69b0            jsr        $000769B0
[0004ec44] 5280                      addq.l     #1,d0
[0004ec46] 4eb9 0004 7f44            jsr        $00047F44
[0004ec4c] 23c8 000d 3da8            move.l     a0,$000D3DA8
[0004ec52] 6732                      beq.s      $0004EC86
[0004ec54] 226f 034c                 movea.l    844(a7),a1
[0004ec58] 4eb9 0007 6950            jsr        $00076950
[0004ec5e] 202f 0348                 move.l     840(a7),d0
[0004ec62] 673a                      beq.s      $0004EC9E
[0004ec64] 2040                      movea.l    d0,a0
[0004ec66] 4eb9 0007 69b0            jsr        $000769B0
[0004ec6c] 4eb9 0004 7f44            jsr        $00047F44
[0004ec72] 23c8 000d 3dac            move.l     a0,$000D3DAC
[0004ec78] 6612                      bne.s      $0004EC8C
[0004ec7a] 2079 000d 3da8            movea.l    $000D3DA8,a0
[0004ec80] 4eb9 0004 7fa6            jsr        $00047FA6
[0004ec86] 70ff                      moveq.l    #-1,d0
[0004ec88] 6000 013a                 bra        $0004EDC4
[0004ec8c] 226f 0348                 movea.l    840(a7),a1
[0004ec90] 5249                      addq.w     #1,a1
[0004ec92] 2079 000d 3dac            movea.l    $000D3DAC,a0
[0004ec98] 4eb9 0007 6950            jsr        $00076950
[0004ec9e] 7010                      moveq.l    #16,d0
[0004eca0] 4eb9 0005 1e1c            jsr        $00051E1C
[0004eca6] 4eb9 0004 6d70            jsr        $00046D70
[0004ecac] 3f7c 4722 0352            move.w     #$4722,850(a7)
[0004ecb2] 2055                      movea.l    (a5),a0
[0004ecb4] 3f50 0354                 move.w     (a0),852(a7)
[0004ecb8] 2039 000d 3da8            move.l     $000D3DA8,d0
...
[0004ecd2] 2639 000d 3dac            move.l     $000D3DAC,d3
...
[0004ecea] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004ecf0] 41ef 0352                 lea.l      850(a7),a0
[0004ecf4] 3013                      move.w     (a3),d0
[0004ecf6] 7210                      moveq.l    #16,d1
[0004ecf8] 4eb9 0006 a818            jsr        $0006A818
[0004ecfe] 4a40                      tst.w      d0
[0004ed00] 6700 00a4                 beq        $0004EDA6
[0004ed04] 47ef 0350                 lea.l      848(a7),a3
[0004ed08] 6000 0094                 bra        $0004ED9E
[0004ed0c] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[0004ed42] 4eb9 0006 af70            jsr        $0006AF70
[0004ed48] 4fef 0032                 lea.l      50(a7),a7
[0004ed4c] c07c 0010                 and.w      #$0010,d0
[0004ed50] 674a                      beq.s      $0004ED9C
[0004ed52] 0c6f 0029 0352            cmpi.w     #$0029,850(a7)
[0004ed58] 6612                      bne.s      $0004ED6C
[0004ed5a] 91c8                      suba.l     a0,a0
[0004ed5c] 4eb9 0005 4fcc            jsr        $00054FCC
[0004ed62] 4eb9 0004 63f4            jsr        $000463F4
[0004ed68] 7a00                      moveq.l    #0,d5
[0004ed6a] 603c                      bra.s      $0004EDA8
[0004ed6c] 0c6f 4723 0352            cmpi.w     #$4723,850(a7)
[0004ed72] 660e                      bne.s      $0004ED82
[0004ed74] 302f 0358                 move.w     856(a7),d0
[0004ed78] 6604                      bne.s      $0004ED7E
[0004ed7a] 7aff                      moveq.l    #-1,d5
[0004ed7c] 6002                      bra.s      $0004ED80
[0004ed7e] 7a00                      moveq.l    #0,d5
[0004ed80] 6026                      bra.s      $0004EDA8
[0004ed82] 7020                      moveq.l    #32,d0
[0004ed84] 4eb9 0005 1e1c            jsr        $00051E1C
[0004ed8a] 41ef 0352                 lea.l      850(a7),a0
[0004ed8e] 4eb9 0005 3ade            jsr        $00053ADE
[0004ed94] 7010                      moveq.l    #16,d0
[0004ed96] 4eb9 0005 1e1c            jsr        $00051E1C
[0004ed9c] 5346                      subq.w     #1,d6
[0004ed9e] 4a46                      tst.w      d6
[0004eda0] 6600 ff6a                 bne        $0004ED0C
[0004eda4] 6002                      bra.s      $0004EDA8
[0004eda6] 7aff                      moveq.l    #-1,d5
[0004eda8] 7020                      moveq.l    #32,d0
[0004edaa] 4eb9 0005 1e1c            jsr        $00051E1C
[0004edb0] 4eb9 0004 6d70            jsr        $00046D70
[0004edb6] 4eb9 0004 ad60            jsr        $0004AD60
[0004edbc] 4eb9 0004 b33c            jsr        $0004B33C
...
[0004edd6] 49f9 000d 3d9c            lea.l      $000D3D9C,a4
...
[0004edfa] 6734                      beq.s      $0004EE30
[0004edfc] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[0004eee0] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004eee6] 4242                      clr.w      d2
[0004eee8] 4241                      clr.w      d1
[0004eeea] 302a 0022                 move.w     34(a2),d0
[0004eeee] 4eb9 0006 d0c6            jsr        $0006D0C6
[0004eef4] 584f                      addq.w     #4,a7
[0004eef6] 3600                      move.w     d0,d3
[0004eef8] 6004                      bra.s      $0004EEFE
[0004eefa] b854                      cmp.w      (a4),d4
[0004eefc] 669a                      bne.s      $0004EE98
[0004eefe] 4a43                      tst.w      d3
[0004ef00] 6b0a                      bmi.s      $0004EF0C
[0004ef02] b67c 0080                 cmp.w      #$0080,d3
[0004ef06] 6e04                      bgt.s      $0004EF0C
[0004ef08] 3003                      move.w     d3,d0
[0004ef0a] 6016                      bra.s      $0004EF22
[0004ef0c] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004ef12] 41f9 000c 974b            lea.l      $000C974B,a0
[0004ef18] 7001                      moveq.l    #1,d0
[0004ef1a] 4eb9 0006 be76            jsr        $0006BE76
...
[0004ef2e] 43f9 0010 6fea            lea.l      $00106FEA,a1
[0004ef34] 41f9 000d 3f00            lea.l      $000D3F00,a0
[0004ef3a] 3210                      move.w     (a0),d1
[0004ef3c] b269 0604                 cmp.w      1540(a1),d1
[0004ef40] 6f0c                      ble.s      $0004EF4E
[0004ef42] 4250                      clr.w      (a0)
[0004ef44] 4a40                      tst.w      d0
[0004ef46] 6704                      beq.s      $0004EF4C
[0004ef48] 91c8                      suba.l     a0,a0
[0004ef4a] 6012                      bra.s      $0004EF5E
...
[0004f02c] 672e                      beq.s      $0004F05C
[0004f02e] 240c                      move.l     a4,d2
[0004f030] 672a                      beq.s      $0004F05C
...
[0004f06e] 45f9 000d 3d9c            lea.l      $000D3D9C,a2
[0004f074] 3612                      move.w     (a2),d3
[0004f076] 47f9 0010 6bb6            lea.l      $00106BB6,a3
...
[0004f08e] 672e                      beq.s      $0004F0BE
[0004f090] 240c                      move.l     a4,d2
[0004f092] 672a                      beq.s      $0004F0BE
...
[0004f0f4] 6708                      beq.s      $0004F0FE
[0004f0f6] 4eb9 0004 f41a            jsr        $0004F41A
[0004f0fc] 6002                      bra.s      $0004F100
...
[0004f112] 0c79 ffff 000d 3f42       cmpi.w     #$FFFF,$000D3F42
[0004f11a] 6640                      bne.s      $0004F15C
[0004f11c] 47ef 001c                 lea.l      28(a7),a3
[0004f120] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[0004f132] 4eb9 0006 aad2            jsr        $0006AAD2
[0004f138] 4fef 000c                 lea.l      12(a7),a7
[0004f13c] 4a40                      tst.w      d0
[0004f13e] 6716                      beq.s      $0004F156
[0004f140] 7001                      moveq.l    #1,d0
[0004f142] c06f 001a                 and.w      26(a7),d0
[0004f146] 6704                      beq.s      $0004F14C
[0004f148] 7201                      moveq.l    #1,d1
[0004f14a] 6002                      bra.s      $0004F14E
[0004f14c] 4241                      clr.w      d1
[0004f14e] 33c1 000d 3f42            move.w     d1,$000D3F42
[0004f154] 6006                      bra.s      $0004F15C
[0004f156] 4279 000d 3f42            clr.w      $000D3F42
[0004f15c] 3039 000d 3f42            move.w     $000D3F42,d0
[0004f162] 6732                      beq.s      $0004F196
[0004f164] 0c6a 0014 0006            cmpi.w     #$0014,6(a2)
[0004f16a] 662a                      bne.s      $0004F196
...
[0004f2b8] 6700 fea2                 beq        $0004F15C
...
[0004f2cc] 6100 f33a                 bsr        $0004E608
[0004f2d0] 224a                      movea.l    a2,a1
[0004f2d2] 605e                      bra.s      $0004F332
[0004f2d4] 0c69 0014 0006            cmpi.w     #$0014,6(a1)
[0004f2da] 6628                      bne.s      $0004F304
[0004f2dc] 2008                      move.l     a0,d0
[0004f2de] 6706                      beq.s      $0004F2E6
[0004f2e0] b5e8 005e                 cmpa.l     94(a0),a2
[0004f2e4] 6718                      beq.s      $0004F2FE
...
[0004f30a] 6722                      beq.s      $0004F32E
[0004f30c] 0c69 0018 0006            cmpi.w     #$0018,6(a1)
[0004f312] 661a                      bne.s      $0004F32E
[0004f314] 2669 000c                 movea.l    12(a1),a3
[0004f318] 2653                      movea.l    (a3),a3
[0004f31a] b7fc 0005 b212            cmpa.l     #$0005B212,a3
[0004f320] 660c                      bne.s      $0004F32E
...
[0004f3da] 6704                      beq.s      $0004F3E0
[0004f3dc] 3017                      move.w     (a7),d0
[0004f3de] 6716                      beq.s      $0004F3F6
[0004f3e0] 4a43                      tst.w      d3
[0004f3e2] 670a                      beq.s      $0004F3EE
[0004f3e4] 206c 005e                 movea.l    94(a4),a0
[0004f3e8] 6100 fedc                 bsr        $0004F2C6
[0004f3ec] 6008                      bra.s      $0004F3F6
[0004f3ee] 206c 005e                 movea.l    94(a4),a0
[0004f3f2] 6100 fd10                 bsr        $0004F104
[0004f3f6] 5244                      addq.w     #1,d4
[0004f3f8] b87c 0100                 cmp.w      #$0100,d4
[0004f3fc] 6db8                      blt.s      $0004F3B6
[0004f3fe] 4a45                      tst.w      d5
[0004f400] 6710                      beq.s      $0004F412
...
[0004f40c] 4eb9 0005 5058            jsr        $00055058
...
[0004f4a2] 6708                      beq.s      $0004F4AC
[0004f4a4] 2040                      movea.l    d0,a0
[0004f4a6] 6100 fe1e                 bsr        $0004F2C6
[0004f4aa] 6008                      bra.s      $0004F4B4
[0004f4ac] 206a 005e                 movea.l    94(a2),a0
[0004f4b0] 6100 fc52                 bsr        $0004F104
[0004f4b4] 206a 005e                 movea.l    94(a2),a0
[0004f4b8] 4eb9 0004 a25e            jsr        $0004A25E
[0004f4be] 206a 005e                 movea.l    94(a2),a0
[0004f4c2] 4eb9 0004 975e            jsr        $0004975E
[0004f4c8] 202a 005a                 move.l     90(a2),d0
[0004f4cc] 6740                      beq.s      $0004F50E
[0004f4ce] 2040                      movea.l    d0,a0
[0004f4d0] 4eb9 0004 9e38            jsr        $00049E38
[0004f4d6] 2548 005a                 move.l     a0,90(a2)
[0004f4da] 2008                      move.l     a0,d0
[0004f4dc] 6630                      bne.s      $0004F50E
[0004f4de] 206a 005e                 movea.l    94(a2),a0
[0004f4e2] 4eb9 0004 9b7c            jsr        $00049B7C
[0004f4e8] 206a 0018                 movea.l    24(a2),a0
[0004f4ec] 4eb9 0004 9b7c            jsr        $00049B7C
[0004f4f2] 206a 0014                 movea.l    20(a2),a0
[0004f4f6] 4eb9 0004 9b7c            jsr        $00049B7C
[0004f4fc] 203c 0000 00a2            move.l     #$000000A2,d0
[0004f502] 204a                      movea.l    a2,a0
[0004f504] 4eb9 0004 8140            jsr        $00048140
[0004f50a] 6000 0108                 bra        $0004F614
[0004f50e] 204a                      movea.l    a2,a0
[0004f510] 4eb9 0004 b5cc            jsr        $0004B5CC
[0004f516] 202a 004a                 move.l     74(a2),d0
[0004f51a] 670c                      beq.s      $0004F528
...
[0004f576] 49f9 0010 6fea            lea.l      $00106FEA,a4
[0004f57c] 4bf9 000d 3dc8            lea.l      $000D3DC8,a5
[0004f582] 6074                      bra.s      $0004F5F8
[0004f584] 3003                      move.w     d3,d0
[0004f586] e548                      lsl.w      #2,d0
[0004f588] 2234 0000                 move.l     0(a4,d0.w),d1
[0004f58c] 6668                      bne.s      $0004F5F6
[0004f58e] b66c 0604                 cmp.w      1540(a4),d3
[0004f592] 6f04                      ble.s      $0004F598
...
[0004f5f4] 6020                      bra.s      $0004F616
[0004f5f6] 5243                      addq.w     #1,d3
[0004f5f8] b67c 0100                 cmp.w      #$0100,d3
[0004f5fc] 6d00 ff86                 blt.w      $0004F584
[0004f600] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004f606] 41f9 000c 97b8            lea.l      $000C97B8,a0
[0004f60c] 7001                      moveq.l    #1,d0
[0004f60e] 4eb9 0006 be76            jsr        $0006BE76
...
[0004f644] 4eb9 0007 1656            jsr        $00071656
...
[0004f67a] 4eb9 0007 1656            jsr        $00071656
...
[0004f690] 4eb9 0007 1656            jsr        $00071656
...
[0004f6ac] 4bf9 000d 3dc8            lea.l      $000D3DC8,a5
...
[0004f6c0] 6a00 030e                 bpl        $0004F9D0
[0004f6c4] 7204                      moveq.l    #4,d1
[0004f6c6] c26a 0056                 and.w      86(a2),d1
[0004f6ca] 6712                      beq.s      $0004F6DE
...
[0004f734] 4eb9 0007 1656            jsr        $00071656
...
[0004f748] 4eb9 0007 1656            jsr        $00071656
...
[0004f75c] 4eb9 0007 1656            jsr        $00071656
[0004f762] 504f                      addq.w     #8,a7
[0004f764] 302a 0026                 move.w     38(a2),d0
[0004f768] 6600 00ba                 bne        $0004F824
...
[0004f77c] 6700 0086                 beq        $0004F804
[0004f780] 242a 0014                 move.l     20(a2),d2
[0004f784] 6700 007e                 beq.w      $0004F804
[0004f788] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[0004f7a0] 4eb9 0006 bf48            jsr        $0006BF48
...
[0004f7f8] 4eb9 0006 d60a            jsr        $0006D60A
[0004f7fe] 4fef 0012                 lea.l      18(a7),a7
[0004f802] 6020                      bra.s      $0004F824
...
[0004f8a6] 4eb9 0004 b286            jsr        $0004B286
...
[0004f9e6] 45f9 000d 3dc8            lea.l      $000D3DC8,a2
...
[0004fa60] 4eb9 0007 1656            jsr        $00071656
...
[0004fa74] 4eb9 0007 1656            jsr        $00071656
...
[0004fb04] 4eb9 0004 b286            jsr        $0004B286
...
[0004fb3e] 2079 000d 99d6            movea.l    $000D99D6,a0
[0004fb44] 4eb9 0006 c564            jsr        $0006C564
...
[0004fb98] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004fb9e] 204c                      movea.l    a4,a0
[0004fba0] 7210                      moveq.l    #16,d1
[0004fba2] 3015                      move.w     (a5),d0
[0004fba4] 4eb9 0006 a818            jsr        $0006A818
[0004fbaa] 600e                      bra.s      $0004FBBA
[0004fbac] 204d                      movea.l    a5,a0
[0004fbae] 4eb9 0005 4250            jsr        $00054250
[0004fbb4] 2a48                      movea.l    a0,a5
[0004fbb6] 200d                      move.l     a5,d0
[0004fbb8] 66ba                      bne.s      $0004FB74
[0004fbba] 4eb9 0004 6d70            jsr        $00046D70
...
[0004fc20] 6100 ffd6                 bsr.w      $0004FBF8
[0004fc24] 2448                      movea.l    a0,a2
[0004fc26] 200a                      move.l     a2,d0
[0004fc28] 6700 0150                 beq        $0004FD7A
...
[0004fc72] 6100 e80e                 bsr        $0004E482
[0004fc76] 6000 0102                 bra        $0004FD7A
...
[0004fcc0] 6c02                      bge.s      $0004FCC4
[0004fcc2] 600e                      bra.s      $0004FCD2
...
[0004fcf2] 6c02                      bge.s      $0004FCF6
[0004fcf4] 600e                      bra.s      $0004FD04
...
[0004fd12] 6f02                      ble.s      $0004FD16
[0004fd14] 6004                      bra.s      $0004FD1A
...
[0004fd28] 6f02                      ble.s      $0004FD2C
[0004fd2a] 6004                      bra.s      $0004FD30
...
[0004fd3c] 4eb9 0005 080a            jsr        $0005080A
...
[0004fd58] 4eb9 0007 1656            jsr        $00071656
[0004fd5e] 504f                      addq.w     #8,a7
[0004fd60] 6018                      bra.s      $0004FD7A
...
[0004fd6e] 670a                      beq.s      $0004FD7A
[0004fd70] 7207                      moveq.l    #7,d1
[0004fd72] 7002                      moveq.l    #2,d0
[0004fd74] 4eb9 0007 284a            jsr        $0007284A
...
[0004fe3a] 3239 0010 75ec            move.w     $001075EC,d1
[0004fe40] 6700 01b4                 beq        $0004FFF6
[0004fe44] 2439 000d 3dc8            move.l     $000D3DC8,d2
[0004fe4a] 6700 01aa                 beq        $0004FFF6
[0004fe4e] 2042                      movea.l    d2,a0
[0004fe50] 2228 005e                 move.l     94(a0),d1
[0004fe54] 6700 01a0                 beq        $0004FFF6
[0004fe58] 2441                      movea.l    d1,a2
[0004fe5a] 4a40                      tst.w      d0
[0004fe5c] 6700 00a2                 beq        $0004FF00
[0004fe60] 6100 fd96                 bsr        $0004FBF8
[0004fe64] 2008                      move.l     a0,d0
[0004fe66] 6600 018e                 bne        $0004FFF6
[0004fe6a] 4eb9 0005 f57c            jsr        $0005F57C
[0004fe70] 4a40                      tst.w      d0
[0004fe72] 6600 0182                 bne        $0004FFF6
[0004fe76] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004fe7c] 4240                      clr.w      d0
[0004fe7e] 91c8                      suba.l     a0,a0
[0004fe80] 4eb9 0006 b362            jsr        $0006B362
...
[0004fef2] 66e4                      bne.s      $0004FED8
[0004fef4] 3579 000d 3d9e 0044       move.w     $000D3D9E,68(a2)
[0004fefc] 6000 00e8                 bra        $0004FFE6
[0004ff00] 6100 fcf6                 bsr        $0004FBF8
[0004ff04] 2008                      move.l     a0,d0
[0004ff06] 660c                      bne.s      $0004FF14
[0004ff08] 4eb9 0005 f57c            jsr        $0005F57C
[0004ff0e] 4a40                      tst.w      d0
[0004ff10] 6700 00e4                 beq        $0004FFF6
[0004ff14] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004ff1a] 4240                      clr.w      d0
[0004ff1c] 91c8                      suba.l     a0,a0
[0004ff1e] 4eb9 0006 b362            jsr        $0006B362
...
[0004ffe4] 66d8                      bne.s      $0004FFBE
[0004ffe6] 2279 000d 99d6            movea.l    $000D99D6,a1
[0004ffec] 7001                      moveq.l    #1,d0
[0004ffee] 204a                      movea.l    a2,a0
[0004fff0] 4eb9 0006 b362            jsr        $0006B362
...
[00050056] 4eb9 0004 975e            jsr        $0004975E
[0005005c] 2279 000d 99d6            movea.l    $000D99D6,a1
[00050062] 7001                      moveq.l    #1,d0
[00050064] 204c                      movea.l    a4,a0
[00050066] 4eb9 0006 b362            jsr        $0006B362
[0005006c] 33ec 0044 000d 3d9e       move.w     68(a4),$000D3D9E
[00050074] 33fc 0001 0010 75ec       move.w     #$0001,$001075EC
[0005007c] 7004                      moveq.l    #4,d0
[0005007e] c06a 0056                 and.w      86(a2),d0
[00050082] 6718                      beq.s      $0005009C
...
[00050094] 6706                      beq.s      $0005009C
[00050096] 70ff                      moveq.l    #-1,d0
[00050098] 6000 009e                 bra        $00050138
[0005009c] 286a 0014                 movea.l    20(a2),a4
[000500a0] 200c                      move.l     a4,d0
[000500a2] 676e                      beq.s      $00050112
...
[000500ce] 4eb9 0007 1656            jsr        $00071656
...
[000500fa] 2079 000d 99d6            movea.l    $000D99D6,a0
[00050100] 4eb9 0006 bde4            jsr        $0006BDE4
[00050106] 4fef 000c                 lea.l      12(a7),a7
[0005010a] 33fc 0001 0010 75ea       move.w     #$0001,$001075EA
...
[00050148] 6100 faae                 bsr        $0004FBF8
[0005014c] 2008                      move.l     a0,d0
[0005014e] 670a                      beq.s      $0005015A
[00050150] 6100 faa6                 bsr        $0004FBF8
[00050154] b5c8                      cmpa.l     a0,a2
[00050156] 6600 01ce                 bne        $00050326
...
[0005016a] 6706                      beq.s      $00050172
[0005016c] 4eb9 0004 b286            jsr        $0004B286
...
[0005018a] 6606                      bne.s      $00050192
[0005018c] 4eb9 0004 4a26            jsr        $00044A26
[00050192] 47f9 000d 99d6            lea.l      $000D99D6,a3
[00050198] 4a43                      tst.w      d3
[0005019a] 6624                      bne.s      $000501C0
...
[000501a8] 4eb9 0007 1656            jsr        $00071656
[000501ae] 504f                      addq.w     #8,a7
[000501b0] 2253                      movea.l    (a3),a1
[000501b2] 4240                      clr.w      d0
[000501b4] 91c8                      suba.l     a0,a0
[000501b6] 4eb9 0006 b362            jsr        $0006B362
[000501bc] 6000 0156                 bra        $00050314
[000501c0] 49f9 000d 3dc8            lea.l      $000D3DC8,a4
[000501c6] 302a 0056                 move.w     86(a2),d0
[000501ca] c07c 0500                 and.w      #$0500,d0
[000501ce] 662a                      bne.s      $000501FA
[000501d0] 2214                      move.l     (a4),d1
[000501d2] 6726                      beq.s      $000501FA
[000501d4] 342a 0058                 move.w     88(a2),d2
[000501d8] 6b12                      bmi.s      $000501EC
...
[000501fc] 6f00 0116                 ble        $00050314
...
[000502e4] 4eb9 0006 a818            jsr        $0006A818
[000502ea] 600e                      bra.s      $000502FA
[000502ec] 204d                      movea.l    a5,a0
[000502ee] 4eb9 0005 4250            jsr        $00054250
[000502f4] 2a48                      movea.l    a0,a5
[000502f6] 200d                      move.l     a5,d0
[000502f8] 66ba                      bne.s      $000502B4
[000502fa] 4eb9 0004 6d70            jsr        $00046D70
[00050300] 2079 0010 1f12            movea.l    ACSblk,a0
[00050306] 2068 023c                 movea.l    572(a0),a0
[0005030a] 41e8 0038                 lea.l      56(a0),a0
[0005030e] 4eb9 0004 9898            jsr        $00049898
[00050314] 4a43                      tst.w      d3
[00050316] 6b0e                      bmi.s      $00050326
[00050318] 3003                      move.w     d3,d0
[0005031a] e548                      lsl.w      #2,d0
[0005031c] 41f9 0010 6bb6            lea.l      $00106BB6,a0
...
[00050346] 6604                      bne.s      $0005034C
[00050348] 4269 0246                 clr.w      582(a1)
[0005034c] 204a                      movea.l    a2,a0
[0005034e] 4eb9 0005 8928            jsr        $00058928
[00050354] 204a                      movea.l    a2,a0
[00050356] 4eb9 0005 869e            jsr        $0005869E
[0005035c] 204a                      movea.l    a2,a0
[0005035e] 6100 e1d0                 bsr        $0004E530
[00050362] 7664                      moveq.l    #100,d3
[00050364] 600a                      bra.s      $00050370
...
[00050374] 6b04                      bmi.s      $0005037A
[00050376] 4a43                      tst.w      d3
[00050378] 6eec                      bgt.s      $00050366
[0005037a] 4a43                      tst.w      d3
[0005037c] 6e0c                      bgt.s      $0005038A
[0005037e] 026a f7ff 0056            andi.w     #$F7FF,86(a2)
[00050384] 204a                      movea.l    a2,a0
[00050386] 6100 fdb6                 bsr        $0005013E
[0005038a] 47f9 000d 3dc8            lea.l      $000D3DC8,a3
[00050390] 302a 0058                 move.w     88(a2),d0
[00050394] 6b14                      bmi.s      $000503AA
[00050396] 2213                      move.l     (a3),d1
[00050398] 6710                      beq.s      $000503AA
...
[00050460] 6f2e                      ble.s      $00050490
[00050462] 6100 f794                 bsr        $0004FBF8
[00050466] 2008                      move.l     a0,d0
[00050468] 6706                      beq.s      $00050470
[0005046a] 6100 f7ae                 bsr        $0004FC1A
[0005046e] 6020                      bra.s      $00050490
[00050470] 4eb9 0004 b286            jsr        $0004B286
...
[00050482] 4eb9 0007 1656            jsr        $00071656
[00050488] 504f                      addq.w     #8,a7
[0005048a] 204a                      movea.l    a2,a0
[0005048c] 6100 dff4                 bsr        $0004E482
...
[000504a2] 6f00 021e                 ble        $000506C2
...
[000504f4] 6000 0138                 bra        $0005062E
...
[00050542] 6000 00c4                 bra        $00050608
...
[0005056c] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[00050594] 4eb9 0006 d60a            jsr        $0006D60A
...
[00050618] 6606                      bne.s      $00050620
[0005061a] 322b 0012                 move.w     18(a3),d1
[0005061e] 6706                      beq.s      $00050626
...
[00050636] 4eb9 0005 0d24            jsr        $00050D24
...
[00050650] 4eb9 0007 1656            jsr        $00071656
...
[000506bc] 4eb9 0004 b33c            jsr        $0004B33C
...
[000506d4] 6f00 00e0                 ble        $000507B6
...
[000506f2] 41f9 0010 6baa            lea.l      $00106BAA,a0
[000506f8] 3010                      move.w     (a0),d0
[000506fa] b069 0004                 cmp.w      4(a1),d0
[000506fe] 6f02                      ble.s      $00050702
[00050700] 6004                      bra.s      $00050706
...
[00050750] 4eb9 0007 1656            jsr        $00071656
...
[0005078c] 6710                      beq.s      $0005079E
[0005078e] 322a 0020                 move.w     32(a2),d1
[00050792] 3010                      move.w     (a0),d0
[00050794] 204b                      movea.l    a3,a0
[00050796] 4eb9 0005 5058            jsr        $00055058
[0005079c] 6018                      bra.s      $000507B6
...
[000507b0] 4eb9 0004 b33c            jsr        $0004B33C
...
[000507e2] 4eb9 0005 080a            jsr        $0005080A
...
[000507fe] 4eb9 0007 1656            jsr        $00071656
...
[0005081c] 6600 04fc                 bne        $00050D1A
...
[0005089e] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[000508f8] 6c04                      bge.s      $000508FE
[000508fa] 3007                      move.w     d7,d0
[000508fc] 600a                      bra.s      $00050908
...
[00050914] 6c04                      bge.s      $0005091A
[00050916] 3204                      move.w     d4,d1
[00050918] 600a                      bra.s      $00050924
...
[00050930] 6c06                      bge.s      $00050938
[00050932] 3028 0012                 move.w     18(a0),d0
[00050936] 6002                      bra.s      $0005093A
...
[00050946] 6c06                      bge.s      $0005094E
[00050948] 3228 0014                 move.w     20(a0),d1
[0005094c] 6002                      bra.s      $00050950
...
[0005095c] 3039 0010 6fe2            move.w     $00106FE2,d0
...
[00050970] 6c02                      bge.s      $00050974
[00050972] 600e                      bra.s      $00050982
[00050974] 3439 0010 6fe2            move.w     $00106FE2,d2
...
[0005099a] 6c02                      bge.s      $0005099E
[0005099c] 600e                      bra.s      $000509AC
...
[000509b0] 3039 0010 6fe2            move.w     $00106FE2,d0
[000509b6] b06f 000e                 cmp.w      14(a7),d0
[000509ba] 6f02                      ble.s      $000509BE
[000509bc] 6004                      bra.s      $000509C2
...
[000509d0] 6f02                      ble.s      $000509D4
[000509d2] 6004                      bra.s      $000509D8
[000509d4] 322f 000c                 move.w     12(a7),d1
[000509d8] 3f41 000c                 move.w     d1,12(a7)
[000509dc] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[00050a00] 4eb9 0006 d60a            jsr        $0006D60A
...
[00050ae4] 6700 0086                 beq        $00050B6C
...
[00050b18] 6f02                      ble.s      $00050B1C
[00050b1a] 6002                      bra.s      $00050B1E
...
[00050b4e] 4eb9 0005 5058            jsr        $00055058
...
[00050b9a] 6c04                      bge.s      $00050BA0
[00050b9c] 3741 0012                 move.w     d1,18(a3)
[00050ba0] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[00050c32] 4eb9 0007 1656            jsr        $00071656
...
[00050cd0] 4eb9 0007 1656            jsr        $00071656
...
[00050d12] 4eb9 0007 1656            jsr        $00071656
...
[00050d50] 6600 0240                 bne        $00050F92
[00050d54] 2a6c 0014                 movea.l    20(a4),a5
[00050d58] 220d                      move.l     a5,d1
[00050d5a] 6700 0236                 beq        $00050F92
[00050d5e] 7208                      moveq.l    #8,d1
[00050d60] c26c 0054                 and.w      84(a4),d1
[00050d64] 6700 0196                 beq        $00050EFC
[00050d68] 2f39 000d 99d6            move.l     $000D99D6,-(a7)
...
[00050dc4] 6000 00a4                 bra        $00050E6A
...
[00050e6c] 6e00 ff5a                 bgt        $00050DC8
...
[00050fa8] 6f12                      ble.s      $00050FBC
[00050faa] 342a 0056                 move.w     86(a2),d2
[00050fae] c47c 0c00                 and.w      #$0C00,d2
[00050fb2] 6608                      bne.s      $00050FBC
[00050fb4] 6100 d4d6                 bsr        $0004E48C
[00050fb8] 4a40                      tst.w      d0
[00050fba] 6606                      bne.s      $00050FC2
[00050fbc] 4240                      clr.w      d0
[00050fbe] 6000 01b6                 bra        $00051176
[00050fc2] 2079 0010 1f12            movea.l    ACSblk,a0
[00050fc8] b5e8 0240                 cmpa.l     576(a0),a2
[00050fcc] 660c                      bne.s      $00050FDA
[00050fce] 4eb9 0004 4a26            jsr        $00044A26
[00050fd4] 4eb9 0004 6d70            jsr        $00046D70
...
[0005100a] 4eb9 0007 6f44            jsr        $00076F44
[00051010] 47f9 000d 99d6            lea.l      $000D99D6,a3
[00051016] 2053                      movea.l    (a3),a0
[00051018] 302a 0020                 move.w     32(a2),d0
[0005101c] 4eb9 0006 d1ba            jsr        $0006D1BA
...
[00051032] 4eb9 0007 1656            jsr        $00071656
...
[0005104a] 4eb9 0006 d140            jsr        $0006D140
[00051050] 584f                      addq.w     #4,a7
[00051052] 7219                      moveq.l    #25,d1
[00051054] 302a 0020                 move.w     32(a2),d0
[00051058] 4eb9 0007 1656            jsr        $00071656
[0005105e] 49f9 0010 6bb6            lea.l      $00106BB6,a4
...
[00051088] 4eb9 0007 14ea            jsr        $000714EA
...
[000510ba] 6720                      beq.s      $000510DC
[000510bc] 3428 001e                 move.w     30(a0),d2
[000510c0] 671a                      beq.s      $000510DC
...
[000511c4] 4eb9 0007 1656            jsr        $00071656
[000511ca] 504f                      addq.w     #8,a7
[000511cc] 4eb9 0004 b286            jsr        $0004B286
...
[000511e0] 4eb9 0007 1656            jsr        $00071656
...
[00051260] 4eb9 0004 6d70            jsr        $00046D70
[00051266] 5243                      addq.w     #1,d3
[00051268] b67c 0080                 cmp.w      #$0080,d3
[0005126c] 6dd0                      blt.s      $0005123E
...
[0005127e] 6702                      beq.s      $00051282
[00051280] 600a                      bra.s      $0005128C
[00051282] 204a                      movea.l    a2,a0
[00051284] 6100 f0aa                 bsr        $00050330
[00051288] 7001                      moveq.l    #1,d0
[0005128a] 6002                      bra.s      $0005128E
...
[000512a2] 4bf9 000d 99d6            lea.l      $000D99D6,a5
[000512a8] 302a 0056                 move.w     86(a2),d0
[000512ac] c07c 0800                 and.w      #$0800,d0
[000512b0] 6600 007a                 bne.w      $0005132C
[000512b4] 3239 000d 5026            move.w     $000D5026,d1
[000512ba] 672c                      beq.s      $000512E8
[000512bc] 242a 0014                 move.l     20(a2),d2
[000512c0] 676a                      beq.s      $0005132C
[000512c2] 41d7                      lea.l      (a7),a0
[000512c4] 4eb9 0005 f4e8            jsr        $0005F4E8
[000512ca] 2054                      movea.l    (a4),a0
[000512cc] 214a 0258                 move.l     a2,600(a0)
[000512d0] 206a 0014                 movea.l    20(a2),a0
[000512d4] 4eb9 0005 f8ee            jsr        $0005F8EE
[000512da] 3600                      move.w     d0,d3
[000512dc] 41d7                      lea.l      (a7),a0
[000512de] 4eb9 0005 f532            jsr        $0005F532
[000512e4] 6000 0320                 bra        $00051606
[000512e8] 302a 0020                 move.w     32(a2),d0
[000512ec] 6a2e                      bpl.s      $0005131C
...
[00051360] 4eb9 0007 14ea            jsr        $000714EA
[00051366] 4fef 0010                 lea.l      16(a7),a7
[0005136a] 302a 0020                 move.w     32(a2),d0
[0005136e] 6b0e                      bmi.s      $0005137E
[00051370] b06f 0028                 cmp.w      40(a7),d0
[00051374] 6708                      beq.s      $0005137E
[00051376] 204a                      movea.l    a2,a0
[00051378] 6100 f0da                 bsr        $00050454
[0005137c] 602e                      bra.s      $000513AC
...
[0005138e] 6716                      beq.s      $000513A6
[00051390] 41d7                      lea.l      (a7),a0
[00051392] 4eb9 0005 f532            jsr        $0005F532
[00051398] 4240                      clr.w      d0
[0005139a] 204a                      movea.l    a2,a0
[0005139c] 6100 e9e4                 bsr        $0004FD82
[000513a0] 70fe                      moveq.l    #-2,d0
[000513a2] 6000 0264                 bra        $00051608
[000513a6] 026a feff 0056            andi.w     #$FEFF,86(a2)
[000513ac] 302a 0058                 move.w     88(a2),d0
[000513b0] 4a40                      tst.w      d0
[000513b2] 6b18                      bmi.s      $000513CC
[000513b4] 2039 000d 3dc8            move.l     $000D3DC8,d0
[000513ba] 6710                      beq.s      $000513CC
...
[000513e8] 4eb9 0006 c978            jsr        $0006C978
...
[00051400] 4eb9 0005 1e1c            jsr        $00051E1C
...
[00051468] 4eb9 0006 af70            jsr        $0006AF70
...
[000514f2] 4eb9 0006 c978            jsr        $0006C978
[000514f8] 4fef 000c                 lea.l      12(a7),a7
[000514fc] 2054                      movea.l    (a4),a0
[000514fe] 3028 02ca                 move.w     714(a0),d0
[00051502] 6612                      bne.s      $00051516
[00051504] 7204                      moveq.l    #4,d1
[00051506] c244                      and.w      d4,d1
[00051508] 6706                      beq.s      $00051510
[0005150a] 4eb9 0004 63f4            jsr        $000463F4
[00051510] 4eb9 0004 6bf0            jsr        $00046BF0
[00051516] 4eb9 0004 7ef6            jsr        $00047EF6
[0005151c] 6100 da7c                 bsr        $0004EF9A
[00051520] 2054                      movea.l    (a4),a0
[00051522] 2179 000d 3dc8 0258       move.l     $000D3DC8,600(a0)
...
[000515e8] 6100 e798                 bsr        $0004FD82
[000515ec] 026a fbff 0056            andi.w     #$FBFF,86(a2)
[000515f2] 41d7                      lea.l      (a7),a0
[000515f4] 4eb9 0005 f532            jsr        $0005F532
[000515fa] 4eb9 0004 6d70            jsr        $00046D70
[00051600] 4eb9 0004 6d70            jsr        $00046D70
...
[000516e4] 6a04                      bpl.s      $000516EA
[000516e6] 7001                      moveq.l    #1,d0
[000516e8] 603c                      bra.s      $00051726
...
[000517bc] 4eb9 0004 a3be            jsr        $0004A3BE
...
[0005184e] 6600 0090                 bne        $000518E0
[00051852] 6000 0096                 bra        $000518EA
...
[00051868] 670a                      beq.s      $00051874
[0005186a] 5340                      subq.w     #1,d0
[0005186c] 6720                      beq.s      $0005188E
[0005186e] 5340                      subq.w     #1,d0
[00051870] 6736                      beq.s      $000518A8
[00051872] 604e                      bra.s      $000518C2
...
[000518de] 670a                      beq.s      $000518EA
[000518e0] 204a                      movea.l    a2,a0
[000518e2] 4eb9 0004 371c            jsr        $0004371C
[000518e8] 6004                      bra.s      $000518EE
...
[00051972] 6276                      bhi.s      $000519EA
[00051974] d040                      add.w      d0,d0
[00051976] 303b 0006                 move.w     $0005197E(pc,d0.w),d0
[0005197a] 4efb 0002                 jmp        $0005197E(pc,d0.w)
J44:
[0005197e] 000a                      dc.w $000a   ; $00051988-$0005197e
[00051980] 0020                      dc.w $0020   ; $0005199e-$0005197e
[00051982] 002c                      dc.w $002c   ; $000519aa-$0005197e
[00051984] 0038                      dc.w $0038   ; $000519b6-$0005197e
[00051986] 0044                      dc.w $0044   ; $000519c2-$0005197e
...
[00051c2c] 4eb9 0007 6a1a            jsr        $00076A1A
...
[00051cd6] 4eb9 0007 6a1a            jsr        $00076A1A
...
[00051cec] 4eb9 0004 afe0            jsr        $0004AFE0
[00051cf2] 226b 0014                 movea.l    20(a3),a1
[00051cf6] 43e9 0258                 lea.l      600(a1),a1
[00051cfa] 204d                      movea.l    a5,a0
[00051cfc] 4eb9 0005 1ddc            jsr        $00051DDC
[00051d02] 603a                      bra.s      $00051D3E
...
[00051d8e] 670a                      beq.s      $00051D9A
[00051d90] 5540                      subq.w     #2,d0
[00051d92] 670a                      beq.s      $00051D9E
[00051d94] 5540                      subq.w     #2,d0
[00051d96] 670a                      beq.s      $00051DA2
[00051d98] 600c                      bra.s      $00051DA6
[00051d9a] 7001                      moveq.l    #1,d0
[00051d9c] 6034                      bra.s      $00051DD2
[00051d9e] 7002                      moveq.l    #2,d0
[00051da0] 6030                      bra.s      $00051DD2
[00051da2] 7003                      moveq.l    #3,d0
[00051da4] 602c                      bra.s      $00051DD2
[00051da6] 4a46                      tst.w      d6
[00051da8] 6b04                      bmi.s      $00051DAE
[00051daa] 70ff                      moveq.l    #-1,d0
[00051dac] 6024                      bra.s      $00051DD2
[00051dae] 206f 0024                 movea.l    36(a7),a0
[00051db2] 0c28 0033 0001            cmpi.b     #$33,1(a0)
[00051db8] 6f06                      ble.s      $00051DC0
[00051dba] 117c 0031 0001            move.b     #$31,1(a0)
[00051dc0] 2279 000d 99d6            movea.l    $000D99D6,a1
[00051dc6] 206f 0024                 movea.l    36(a7),a0
[00051dca] 3005                      move.w     d5,d0
[00051dcc] 4eb9 0006 be76            jsr        $0006BE76
...
[00052028] 670c                      beq.s      $00052036
[0005202a] 302f 000a                 move.w     10(a7),d0
[0005202e] 6606                      bne.s      $00052036
[00052030] 91c8                      suba.l     a0,a0
[00052032] 6000 009e                 bra        $000520D2
...
[00052042] 6100 fee8                 bsr        $00051F2C
[00052046] 584f                      addq.w     #4,a7
[00052048] 3017                      move.w     (a7),d0
[0005204a] 6b00 0082                 bmi        $000520CE
...
[0005214e] 6100 fe9e                 bsr        $00051FEE
[00052152] 4fef 000a                 lea.l      10(a7),a7
[00052156] 2848                      movea.l    a0,a4
[00052158] 4eb9 0004 3a92            jsr        $00043A92
[0005215e] 4a40                      tst.w      d0
[00052160] 666a                      bne.s      $000521CC
...
[0005217e] 4eb9 0005 c7dc            jsr        $0005C7DC
...
[000521b8] 6704                      beq.s      $000521BE
[000521ba] 7601                      moveq.l    #1,d3
[000521bc] 600e                      bra.s      $000521CC
...
[00052282] 51c8 fffc                 dbf        d0,$00052280
...
[0005229e] 6068                      bra.s      $00052308
[000522a0] 4246                      clr.w      d6
[000522a2] 6054                      bra.s      $000522F8
...
[000522b0] 4eb9 0007 69b0            jsr        $000769B0
...
[000523b6] 6c04                      bge.s      $000523BC
[000523b8] 7002                      moveq.l    #2,d0
[000523ba] 6056                      bra.s      $00052412
[000523bc] 487a fe8e                 pea.l      $0005224C(pc)
[000523c0] 7208                      moveq.l    #8,d1
[000523c2] 3039 000d 3fce            move.w     $000D3FCE,d0
[000523c8] 48c0                      ext.l      d0
[000523ca] 43f9 000d 3fa6            lea.l      $000D3FA6,a1
[000523d0] 206a 0004                 movea.l    4(a2),a0
[000523d4] 4eb9 0007 5178            jsr        $00075178
[000523da] 584f                      addq.w     #4,a7
[000523dc] 2448                      movea.l    a0,a2
[000523de] 2253                      movea.l    (a3),a1
[000523e0] 2051                      movea.l    (a1),a0
[000523e2] 4eb9 0004 371c            jsr        $0004371C
[000523e8] 200a                      move.l     a2,d0
[000523ea] 6608                      bne.s      $000523F4
[000523ec] 41f9 000d 406e            lea.l      $000D406E,a0
[000523f2] 6006                      bra.s      $000523FA
...
[00052426] 4eb9 0004 371c            jsr        $0004371C
...
[0005244e] 6100 cc7a                 bsr        $0004F0CA
[00052452] 2053                      movea.l    (a3),a0
[00052454] 2050                      movea.l    (a0),a0
[00052456] 4eb9 0004 371c            jsr        $0004371C
...
[00052572] 4eb9 0007 68ce            jsr        $000768CE
[00052578] 2008                      move.l     a0,d0
[0005257a] 6706                      beq.s      $00052582
[0005257c] 3614                      move.w     (a4),d3
[0005257e] 7801                      moveq.l    #1,d4
[00052580] 6008                      bra.s      $0005258A
...
[0005259a] 672a                      beq.s      $000525C6
[0005259c] 4245                      clr.w      d5
[0005259e] 602e                      bra.s      $000525CE
...
[000525ba] 6610                      bne.s      $000525CC
[000525bc] 204b                      movea.l    a3,a0
[000525be] 3014                      move.w     (a4),d0
[000525c0] 4eb9 0004 418a            jsr        $0004418A
[000525c6] 7002                      moveq.l    #2,d0
[000525c8] 6000 00f2                 bra        $000526BC
[000525cc] 5245                      addq.w     #1,d5
[000525ce] ba54                      cmp.w      (a4),d5
[000525d0] 6dce                      blt.s      $000525A0
[000525d2] 4a44                      tst.w      d4
[000525d4] 661a                      bne.s      $000525F0
...
[0005265a] 4eb9 0004 38ac            jsr        $000438AC
[00052660] 4a40                      tst.w      d0
[00052662] 6718                      beq.s      $0005267C
