...
Awi_keys:
[0005ef2c] 4eb9 0004 cb48            jsr        Awi_keysend
[0005ef32] b07c ffff                 cmp.w      #$FFFF,d0
[0005ef36] 6c04                      bge.s      Awi_keys_1
[0005ef38] 72ff                      moveq.l    #-1,d1
[0005ef3a] 6002                      bra.s      Awi_keys_2
Awi_keys_1:
...
[0005ef48] 6a14                      bpl.s      Awi_nokey_1
[0005ef4a] 1001                      move.b     d1,d0
[0005ef4c] 4880                      ext.w      d0
[0005ef4e] 907c 000e                 sub.w      #$000E,d0
[0005ef52] 6702                      beq.s      Awi_nokey_2
[0005ef54] 6008                      bra.s      Awi_nokey_1
Awi_nokey_2:
[0005ef56] 204a                      movea.l    a2,a0
[0005ef58] 4eb9 0004 c8b2            jsr        Awi_help
Awi_nokey_1:
...
[0005f0aa] 2279 000d 99d6            movea.l    _globl,a1
[0005f0b0] 4eb9 0006 b93c            jsr        mt_objc_draw
...
[0005f11e] 671a                      beq.s      Aform_do_5
[0005f120] 2f39 000d 99d6            move.l     _globl,-(a7)
...
[0005f132] 4eb9 0006 bb32            jsr        mt_objc_edit
[0005f138] 584f                      addq.w     #4,a7
Aform_do_5:
[0005f13a] 2f39 000d 99d6            move.l     _globl,-(a7)
...
[0005f182] 4eb9 0006 af70            jsr        mt_evnt_multi
...
[0005f254] 4eb9 0004 1ec2            jsr        nkc_n2gem
...
[0005f264] 4eb9 0006 bfda            jsr        mt_form_keybd
...
[0005f2e0] 4eb9 0006 bb32            jsr        mt_objc_edit
...
[0005f300] 2f39 000d 99d6            move.l     _globl,-(a7)
...
[0005f340] 4eb9 0006 bb32            jsr        mt_objc_edit
[0005f346] 584f                      addq.w     #4,a7
[0005f348] 2f39 000d 99d6            move.l     _globl,-(a7)
...
[0005f35a] 4eb9 0006 bb32            jsr        mt_objc_edit
[0005f360] 584f                      addq.w     #4,a7
[0005f362] 603e                      bra.s      Aform_do_6
Aform_do_12:
...
[0005f404] 670c                      beq.s      Aform_do_16
[0005f406] 7207                      moveq.l    #7,d1
[0005f408] 7002                      moveq.l    #2,d0
[0005f40a] 4eb9 0007 284a            jsr        Bconout
[0005f410] 605a                      bra.s      Aform_do_13
Aform_do_16:
[0005f412] 2279 000d 99d6            movea.l    _globl,a1
...
[0005f422] 4eb9 0006 c67c            jsr        mt_graf_watchbox
[0005f428] 4a40                      tst.w      d0
[0005f42a] 6640                      bne.s      Aform_do_13
[0005f42c] 3205                      move.w     d5,d1
[0005f42e] 4240                      clr.w      d0
[0005f430] 2054                      movea.l    (a4),a0
[0005f432] 2068 0258                 movea.l    600(a0),a0
[0005f436] 6100 fba8                 bsr        dia_obchange
[0005f43a] 6030                      bra.s      Aform_do_13
Aform_do_14:
...
[0005f48a] 671a                      beq.s      Aform_do_4
[0005f48c] 2f39 000d 99d6            move.l     _globl,-(a7)
...
[0005f4c8] 6012                      bra.s      Aform_do_21
Aform_do_20:
...
[0005f524] 4eb9 0004 99ce            jsr        Amo_restart
...
[0005f572] 4eb9 0004 9a14            jsr        Amo_return
[0005f578] 245f                      movea.l    (a7)+,a2
[0005f57a] 4e75                      rts

A_isModDia:
[0005f57c] 3039 000d 5026            move.w     a_dialog_active,d0
[0005f582] 6f04                      ble.s      A_isModDia_1
...
[0005f598] 4eb9 0004 63f4            jsr        Aev_unhidepointer
[0005f59e] 41ef 0020                 lea.l      32(a7),a0
[0005f5a2] 6100 ff44                 bsr        Act_save
[0005f5a6] 204a                      movea.l    a2,a0
[0005f5a8] 4eb9 0004 a25e            jsr        Aob_fix
...
[0005f5d4] 4eb9 0007 6f44            jsr        memcpy
...
[0005f61a] 237c 0005 f08a 006a       move.l     #dia_redraw,106(a1)
[0005f622] 2053                      movea.l    (a3),a0
[0005f624] 2268 0258                 movea.l    600(a0),a1
[0005f628] 237c 0005 efe0 0066       move.l     #dia_obchange,102(a1)
...
[0005f644] 6700 007e                 beq.w      A_exdialog_1
...
[0005f654] 6722                      beq.s      A_exdialog_2
[0005f656] 2f39 000d 99d6            move.l     _globl,-(a7)
...
[0005f66c] 4eb9 0006 bf48            jsr        mt_form_center
[0005f672] 4fef 0010                 lea.l      16(a7),a7
[0005f676] 605e                      bra.s      A_exdialog_3
A_exdialog_2:
[0005f678] 2f39 000d 99d6            move.l     _globl,-(a7)
...
[0005f68e] 4eb9 0006 c978            jsr        mt_graf_mkstate
...
[0005f6c2] 6012                      bra.s      A_exdialog_3
A_exdialog_1:
...
[0005f6ea] 5279 000d 5026            addq.w     #1,a_dialog_active
[0005f6f0] 7003                      moveq.l    #3,d0
[0005f6f2] 4eb9 0005 1e1c            jsr        Awi_update
[0005f6f8] 4240                      clr.w      d0
[0005f6fa] 4eb9 0004 fe36            jsr        Awi_show_menu
A_exdialog_10:
[0005f700] 2253                      movea.l    (a3),a1
[0005f702] 5049                      addq.w     #8,a1
[0005f704] 204d                      movea.l    a5,a0
[0005f706] 4eb9 0005 f8fe            jsr        fitin
...
[0005f720] 4eb9 0004 a548            jsr        Aob_save
...
[0005f742] 2279 000d 99d6            movea.l    _globl,a1
[0005f748] 4eb9 0006 b93c            jsr        mt_objc_draw
[0005f74e] 5c4f                      addq.w     #6,a7
[0005f750] 4244                      clr.w      d4
A_exdialog_7:
[0005f752] 43d7                      lea.l      (a7),a1
[0005f754] 204a                      movea.l    a2,a0
[0005f756] 6100 f964                 bsr        Aform_do
...
[0005f7d6] 6100 f808                 bsr        dia_obchange
A_exdialog_6:
[0005f7da] 2053                      movea.l    (a3),a0
[0005f7dc] 3028 0268                 move.w     616(a0),d0
[0005f7e0] 6620                      bne.s      A_exdialog_4
[0005f7e2] 6000 ff6e                 bra        A_exdialog_7
A_exdialog_5:
...
[0005f7fe] 6700 ff52                 beq        A_exdialog_7
A_exdialog_4:
...
[0005f81a] 4eb9 0004 a64c            jsr        Aob_restore
[0005f820] 4a44                      tst.w      d4
[0005f822] 660a                      bne.s      A_exdialog_8
[0005f824] 302a 000a                 move.w     10(a2),d0
[0005f828] c07c 4000                 and.w      #$4000,d0
[0005f82c] 6658                      bne.s      A_exdialog_9
A_exdialog_8:
...
[0005f842] 6742                      beq.s      A_exdialog_9
[0005f844] 2f39 000d 99d6            move.l     _globl,-(a7)
...
[0005f8cc] 4eb9 0007 6f44            jsr        memcpy
[0005f8d2] 41ef 0020                 lea.l      32(a7),a0
[0005f8d6] 6100 fc5a                 bsr        Act_restore
[0005f8da] 7001                      moveq.l    #1,d0
[0005f8dc] 4eb9 0004 fe36            jsr        Awi_show_menu
...
[0005f958] 6c02                      bge.s      intersect_1
[0005f95a] 6006                      bra.s      intersect_2
intersect_1:
...
[0005f974] 6c02                      bge.s      intersect_3
[0005f976] 6008                      bra.s      intersect_4
intersect_3:
...
[0005f984] 6f02                      ble.s      intersect_5
[0005f986] 6002                      bra.s      intersect_6
intersect_5:
...
[0005f994] 6f02                      ble.s      intersect_7
[0005f996] 6004                      bra.s      intersect_8
intersect_7:
...
[0005f9b6] 6f04                      ble.s      intersect_9
[0005f9b8] 4a40                      tst.w      d0
[0005f9ba] 6e0e                      bgt.s      intersect_10
intersect_9:
...
[0005fa2a] 51c8 fffc                 dbf        d0,scrp_chg_1
...
[0005fcc0] 6746                      beq.s      Ascrp_get_11
[0005fcc2] 2054                      movea.l    (a4),a0
[0005fcc4] 4240                      clr.w      d0
[0005fcc6] 4eb9 0007 29f0            jsr        Fopen
[0005fccc] 2800                      move.l     d0,d4
[0005fcce] 4a80                      tst.l      d0
[0005fcd0] 6a0a                      bpl.s      Ascrp_get_12
[0005fcd2] 2055                      movea.l    (a5),a0
[0005fcd4] 4eb9 0004 7e26            jsr        Ax_free
[0005fcda] 602c                      bra.s      Ascrp_get_11
Ascrp_get_12:
[0005fcdc] 2055                      movea.l    (a5),a0
[0005fcde] 2212                      move.l     (a2),d1
[0005fce0] 3004                      move.w     d4,d0
[0005fce2] 4eb9 0007 2a02            jsr        Fread
[0005fce8] b092                      cmp.l      (a2),d0
[0005fcea] 670a                      beq.s      Ascrp_get_13
[0005fcec] 2055                      movea.l    (a5),a0
[0005fcee] 4eb9 0004 7e26            jsr        Ax_free
[0005fcf4] 600a                      bra.s      Ascrp_get_14
Ascrp_get_13:
...
[0005fd02] 4eb9 0007 29ae            jsr        Fclose
Ascrp_get_11:
[0005fd08] 200b                      move.l     a3,d0
[0005fd0a] 670a                      beq.s      Ascrp_get_9
[0005fd0c] 2254                      movea.l    (a4),a1
[0005fd0e] 204b                      movea.l    a3,a0
[0005fd10] 4eb9 0004 7286            jsr        Af_2ext
Ascrp_get_9:
[0005fd16] 2057                      movea.l    (a7),a0
[0005fd18] 4eb9 0004 795e            jsr        Af_freedir
Ascrp_get_4:
[0005fd1e] 4eb9 0004 9940            jsr        Amo_unbusy
Ascrp_get_2:
...
[0005fd4c] 6700 00f0                 beq        Ascrp_put_1
[0005fd50] 1212                      move.b     (a2),d1
[0005fd52] 6700 00ea                 beq        Ascrp_put_1
...
[0005fd70] 4eb9 0004 712c            jsr        Af_2path
