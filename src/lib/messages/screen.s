...
[00054b3a] 4eb9 0004 9576            jsr        Ame_root
...
[00054b7c] 675e                      beq.s      Aev_GetWmTopped_1
[00054b7e] 2079 0010 1f12            movea.l    ACSblk,a0
[00054b84] 2068 0280                 movea.l    640(a0),a0
[00054b88] 0c50 0400                 cmpi.w     #$0400,(a0)
[00054b8c] 6c4e                      bge.s      Aev_GetWmTopped_1
[00054b8e] 0c79 0300 0010 2620       cmpi.w     #$0300,_ACSv_magix
[00054b96] 6c44                      bge.s      Aev_GetWmTopped_1
...
[00054bb6] 4eb9 0005 ef64            jsr        Aob_within
[00054bbc] 4a40                      tst.w      d0
[00054bbe] 671c                      beq.s      Aev_GetWmTopped_1
...
[00054bd4] 4eb9 0004 69f2            jsr        evbutton
[00054bda] 6012                      bra.s      Aev_GetWmTopped_2
Aev_GetWmTopped_1:
...
[00054bfe] 4eb9 0004 fbf8            jsr        Awi_modal
...
[00054c92] 6b20                      bmi.s      Aev_GetWmArrowed_1
...
[00054cb2] 6050                      bra.s      Aev_GetWmArrowed_2
Aev_GetWmArrowed_1:
...
[00054cde] 6a24                      bpl.s      Aev_GetWmArrowed_2
...
[00054d20] 4eb9 0007 712e            jsr        memset
...
[00054d48] 4eb9 0004 bfc0            jsr        Awi_wheeled
...
[00054dee] 4eb9 0004 fbcc            jsr        Awi_backdrop
...
[00054dfe] 3039 0010 2620            move.w     _ACSv_magix,d0
[00054e04] 6f12                      ble.s      Aev_GetWmOnTop_1
[00054e06] 0c79 0200 0010 2620       cmpi.w     #$0200,_ACSv_magix
[00054e0e] 6c08                      bge.s      Aev_GetWmOnTop_1
[00054e10] 2057                      movea.l    (a7),a0
[00054e12] 6100 ffd0                 bsr.w      Aev_GetWmBottomed
[00054e16] 600c                      bra.s      Aev_GetWmOnTop_2
Aev_GetWmOnTop_1:
[00054e18] 2057                      movea.l    (a7),a0
[00054e1a] 2068 000c                 movea.l    12(a0),a0
[00054e1e] 4eb9 0004 e482            jsr        Awi_setontop
Aev_GetWmOnTop_2:
...
[00054e9c] 4eb9 0005 5058            jsr        Aev_WmRedraw
...
Aev_GetApTerm:
[00054f02] 4eb9 0004 640a            jsr        Aev_quit
...
[00054f1c] 4eb9 0004 ef62            jsr        Awi_sendall
...
[00054f36] 4eb9 0006 3f0e            jsr        vst_unload_fonts
...
[00054f4a] 4eb9 0006 7090            jsr        vq_extnd
...
[00054f68] 4eb9 0006 3eba            jsr        vst_load_fonts
...
[00054f7c] 4eb9 0004 ef62            jsr        Awi_sendall
...
[00054f96] 4eb9 0004 ef62            jsr        Awi_sendall
...
[00054fae] 6e18                      bgt.s      Aev_GetColorsChanged_1
...
[00054fc2] 4eb9 0005 5058            jsr        Aev_WmRedraw
...
[00054fce] 4eb9 0004 e608            jsr        Awi_root
[00054fd4] 2e88                      move.l     a0,(a7)
[00054fd6] 2017                      move.l     (a7),d0
[00054fd8] 6604                      bne.s      Aev_GetAcClose_1
[00054fda] 4240                      clr.w      d0
[00054fdc] 605a                      bra.s      Aev_GetAcClose_2
Aev_GetAcClose_1:
[00054fde] 4eb9 0004 e58c            jsr        Awi_invalid
[00054fe4] 4eb9 0004 63f4            jsr        Aev_unhidepointer
[00054fea] 91c8                      suba.l     a0,a0
[00054fec] 7001                      moveq.l    #1,d0
[00054fee] 4eb9 0004 ef62            jsr        Awi_sendall
[00054ff4] 2079 0010 1f12            movea.l    ACSblk,a0
[00054ffa] 3028 0238                 move.w     568(a0),d0
[00054ffe] 6636                      bne.s      Aev_GetAcClose_3
[00055000] 2079 000d 2c54            movea.l    ListOfApps,a0
[00055006] 2279 000d 2c54            movea.l    ListOfApps,a1
...
[0005503e] 4eb9 0004 e608            jsr        Awi_root
[00055044] 2e88                      move.l     a0,(a7)
[00055046] 2017                      move.l     (a7),d0
[00055048] 6708                      beq.s      Aev_GetAcOpen_1
[0005504a] 2057                      movea.l    (a7),a0
[0005504c] 4eb9 0004 f0ca            jsr        Awi_show
Aev_GetAcOpen_1:
...
[0005507e] 6a04                      bpl.s      Aev_WmRedraw_1
[00055080] 4240                      clr.w      d0
[00055082] 6004                      bra.s      Aev_WmRedraw_2
Aev_WmRedraw_1:
...
[000550fe] 2079 000d 99d6            movea.l    _globl,a0
...
[00055114] 4eb9 0006 bde4            jsr        mt_form_dial
[0005511a] 4fef 000c                 lea.l      12(a7),a7
Aev_WmRedraw_3:
[0005511e] 302f 0010                 move.w     16(a7),d0
[00055122] 6704                      beq.s      Aev_WmRedraw_4
[00055124] 7001                      moveq.l    #1,d0
[00055126] 6002                      bra.s      Aev_WmRedraw_5
Aev_WmRedraw_4:
