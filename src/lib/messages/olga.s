...
[00057c0a] 4eb9 0006 2a5e            jsr        $00062A5E
[00057c10] 23c8 000d 4bde            move.l     a0,$000D4BDE
[00057c16] 2039 000d 4bde            move.l     $000D4BDE,d0
[00057c1c] 6604                      bne.s      $00057C22
[00057c1e] 4240                      clr.w      d0
[00057c20] 6050                      bra.s      $00057C72
[00057c22] 2079 000d 4bde            movea.l    $000D4BDE,a0
[00057c28] 217c 0005 7e7c 0004       move.l     #$00057E7C,4(a0)
[00057c30] 7210                      moveq.l    #16,d1
[00057c32] 70ff                      moveq.l    #-1,d0
[00057c34] 41f9 000d 4bec            lea.l      $000D4BEC,a0
[00057c3a] 4eb9 0007 712e            jsr        $0007712E
[00057c40] 7001                      moveq.l    #1,d0
[00057c42] c079 0009 bfd2            and.w      $0009BFD2,d0
[00057c48] 6720                      beq.s      $00057C6A
[00057c4a] 7002                      moveq.l    #2,d0
[00057c4c] c079 0009 bfd2            and.w      $0009BFD2,d0
[00057c52] 670a                      beq.s      $00057C5E
[00057c54] 4eb9 0005 7df8            jsr        $00057DF8
[00057c5a] 3e80                      move.w     d0,(a7)
[00057c5c] 600c                      bra.s      $00057C6A
[00057c5e] 4eb9 0005 7da6            jsr        $00057DA6
[00057c64] 33c0 000d 4be2            move.w     d0,$000D4BE2
[00057c6a] 4279 000d 4c00            clr.w      $000D4C00
[00057c70] 3017                      move.w     (a7),d0
[00057c72] 544f                      addq.w     #2,a7
[00057c74] 4e75                      rts
Aev_ExitOlga:
[00057c76] 33fc 0001 000d 4c00       move.w     #$0001,$000D4C00
[00057c7e] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057c84] 6b06                      bmi.s      $00057C8C
[00057c86] 4eb9 0005 8452            jsr        $00058452
[00057c8c] 2039 000d 4bde            move.l     $000D4BDE,d0
[00057c92] 670c                      beq.s      $00057CA0
[00057c94] 2079 000d 4bde            movea.l    $000D4BDE,a0
[00057c9a] 4eb9 0006 2aa6            jsr        $00062AA6
...
[00057d38] 4eb9 0004 e614            jsr        $0004E614
[00057d3e] 584f                      addq.w     #4,a7
[00057d40] 426f 0018                 clr.w      24(a7)
[00057d44] 603e                      bra.s      $00057D84
[00057d46] 2079 000d 99d6            movea.l    $000D99D6,a0
[00057d4c] 7064                      moveq.l    #100,d0
[00057d4e] 4eb9 0006 af04            jsr        $0006AF04
[00057d54] 2279 000d 99d6            movea.l    $000D99D6,a1
[00057d5a] 206f 0020                 movea.l    32(a7),a0
[00057d5e] 4eb9 0006 a886            jsr        $0006A886
[00057d64] 3f40 001a                 move.w     d0,26(a7)
[00057d68] 302f 001a                 move.w     26(a7),d0
[00057d6c] 6a12                      bpl.s      $00057D80
[00057d6e] 2279 000d 99d6            movea.l    $000D99D6,a1
[00057d74] 41d7                      lea.l      (a7),a0
[00057d76] 4eb9 0006 a886            jsr        $0006A886
[00057d7c] 3f40 001a                 move.w     d0,26(a7)
[00057d80] 526f 0018                 addq.w     #1,24(a7)
[00057d84] 3039 000d 4c00            move.w     $000D4C00,d0
[00057d8a] 6610                      bne.s      $00057D9C
[00057d8c] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057d92] 6a08                      bpl.s      $00057D9C
[00057d94] 0c6f 001e 0018            cmpi.w     #$001E,24(a7)
[00057d9a] 6daa                      blt.s      $00057D46
[00057d9c] 302f 001a                 move.w     26(a7),d0
[00057da0] 4fef 0024                 lea.l      36(a7),a7
[00057da4] 4e75                      rts
FindOlgaManager:
[00057da6] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057dac] 6a42                      bpl.s      $00057DF0
[00057dae] 43f9 000d 4c0c            lea.l      $000D4C0C,a1
[00057db4] 41f9 000d 4c03            lea.l      $000D4C03,a0
[00057dba] 6100 fee8                 bsr        $00057CA4
[00057dbe] 33c0 000d 4be2            move.w     d0,$000D4BE2
[00057dc4] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057dca] 6a16                      bpl.s      $00057DE2
[00057dcc] 43f9 000d 4c21            lea.l      $000D4C21,a1
[00057dd2] 41f9 000d 4c18            lea.l      $000D4C18,a0
[00057dd8] 6100 feca                 bsr        $00057CA4
[00057ddc] 33c0 000d 4be2            move.w     d0,$000D4BE2
[00057de2] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057de8] 6b06                      bmi.s      $00057DF0
[00057dea] 4eb9 0005 83dc            jsr        $000583DC
[00057df0] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057df6] 4e75                      rts
CheckOlga:
[00057df8] 554f                      subq.w     #2,a7
[00057dfa] 3039 000d 4bea            move.w     $000D4BEA,d0
[00057e00] 671c                      beq.s      $00057E1E
[00057e02] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057e08] 6b14                      bmi.s      $00057E1E
[00057e0a] 2079 0010 1f12            movea.l    ACSblk,a0
[00057e10] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057e16] b050                      cmp.w      (a0),d0
[00057e18] 6704                      beq.s      $00057E1E
[00057e1a] 7001                      moveq.l    #1,d0
[00057e1c] 605a                      bra.s      $00057E78
[00057e1e] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057e24] 6a0a                      bpl.s      $00057E30
[00057e26] 6100 ff7e                 bsr        $00057DA6
[00057e2a] 33c0 000d 4be2            move.w     d0,$000D4BE2
[00057e30] 3039 000d 4bea            move.w     $000D4BEA,d0
[00057e36] 661a                      bne.s      $00057E52
[00057e38] 4257                      clr.w      (a7)
[00057e3a] 6008                      bra.s      $00057E44
[00057e3c] 4eb9 0004 6d70            jsr        $00046D70
[00057e42] 5257                      addq.w     #1,(a7)
[00057e44] 3039 000d 4bea            move.w     $000D4BEA,d0
[00057e4a] 6606                      bne.s      $00057E52
[00057e4c] 0c57 001e                 cmpi.w     #$001E,(a7)
[00057e50] 6dea                      blt.s      $00057E3C
[00057e52] 3039 000d 4bea            move.w     $000D4BEA,d0
[00057e58] 671c                      beq.s      $00057E76
[00057e5a] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057e60] 6b14                      bmi.s      $00057E76
[00057e62] 2079 0010 1f12            movea.l    ACSblk,a0
[00057e68] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057e6e] b050                      cmp.w      (a0),d0
[00057e70] 6704                      beq.s      $00057E76
[00057e72] 7001                      moveq.l    #1,d0
[00057e74] 6002                      bra.s      $00057E78
...
[00057ee8] 6604                      bne.s      $00057EEE
[00057eea] 7001                      moveq.l    #1,d0
[00057eec] 6002                      bra.s      $00057EF0
...
[00057f14] 4eb9 0004 38ac            jsr        $000438AC
[00057f1a] 4a40                      tst.w      d0
[00057f1c] 6604                      bne.s      $00057F22
[00057f1e] 7001                      moveq.l    #1,d0
[00057f20] 6002                      bra.s      $00057F24
[00057f22] 4240                      clr.w      d0
[00057f24] 601e                      bra.s      $00057F44
...
[00057f34] 4eb9 0004 3856            jsr        $00043856
[00057f3a] 4a40                      tst.w      d0
[00057f3c] 6604                      bne.s      $00057F42
[00057f3e] 7001                      moveq.l    #1,d0
[00057f40] 6002                      bra.s      $00057F44
[00057f42] 4240                      clr.w      d0
[00057f44] 4a40                      tst.w      d0
[00057f46] 671a                      beq.s      $00057F62
...
[00057f5c] 6604                      bne.s      $00057F62
[00057f5e] 7001                      moveq.l    #1,d0
[00057f60] 6002                      bra.s      $00057F64
...
[00057f6e] 487a ff84                 pea.l      $00057EF4(pc)
[00057f72] 226f 0004                 movea.l    4(a7),a1
[00057f76] 2079 000d 4bde            movea.l    $000D4BDE,a0
[00057f7c] 2479 000d 4bde            movea.l    $000D4BDE,a2
...
[00057f96] 487a ff3c                 pea.l      $00057ED4(pc)
[00057f9a] 43ef 0004                 lea.l      4(a7),a1
[00057f9e] 2079 000d 4bde            movea.l    $000D4BDE,a0
[00057fa4] 2479 000d 4bde            movea.l    $000D4BDE,a2
...
[00057ff6] 3039 000d 4be2            move.w     $000D4BE2,d0
[00057ffc] b068 0002                 cmp.w      2(a0),d0
[00058000] 6604                      bne.s      $00058006
[00058002] 7001                      moveq.l    #1,d0
[00058004] 6002                      bra.s      $00058008
[00058006] 4240                      clr.w      d0
[00058008] 3f40 0004                 move.w     d0,4(a7)
[0005800c] 302f 0004                 move.w     4(a7),d0
[00058010] 674e                      beq.s      $00058060
[00058012] 2057                      movea.l    (a7),a0
[00058014] 3028 000e                 move.w     14(a0),d0
[00058018] 662a                      bne.s      $00058044
[0005801a] 33fc ffff 000d 4be2       move.w     #$FFFF,$000D4BE2
[00058022] 4279 000d 4be4            clr.w      $000D4BE4
[00058028] 33fc ffff 000d 4be6       move.w     #$FFFF,$000D4BE6
[00058030] 2079 000d 4bde            movea.l    $000D4BDE,a0
[00058036] 2279 000d 4bde            movea.l    $000D4BDE,a1
[0005803c] 2269 0008                 movea.l    8(a1),a1
[00058040] 4e91                      jsr        (a1)
[00058042] 601c                      bra.s      $00058060
[00058044] 2057                      movea.l    (a7),a0
[00058046] 33e8 0006 000d 4be4       move.w     6(a0),$000D4BE4
[0005804e] 2057                      movea.l    (a7),a0
[00058050] 33e8 0008 000d 4be6       move.w     8(a0),$000D4BE6
[00058058] 33fc 0001 000d 4bea       move.w     #$0001,$000D4BEA
...
[00058076] 3039 000d 4be2            move.w     $000D4BE2,d0
[0005807c] 6b40                      bmi.s      $000580BE
[0005807e] 2057                      movea.l    (a7),a0
[00058080] 3039 000d 4be2            move.w     $000D4BE2,d0
[00058086] b068 0002                 cmp.w      2(a0),d0
[0005808a] 6632                      bne.s      $000580BE
[0005808c] 33fc ffff 000d 4be2       move.w     #$FFFF,$000D4BE2
[00058094] 4279 000d 4be4            clr.w      $000D4BE4
[0005809a] 33fc ffff 000d 4be6       move.w     #$FFFF,$000D4BE6
[000580a2] 4279 000d 4bea            clr.w      $000D4BEA
[000580a8] 2079 000d 4bde            movea.l    $000D4BDE,a0
[000580ae] 2279 000d 4bde            movea.l    $000D4BDE,a1
[000580b4] 2269 0008                 movea.l    8(a1),a1
[000580b8] 4e91                      jsr        (a1)
[000580ba] 7001                      moveq.l    #1,d0
[000580bc] 6002                      bra.s      $000580C0
...
[000580d2] 33e8 0002 000d 4be2       move.w     2(a0),$000D4BE2
[000580da] 2057                      movea.l    (a7),a0
[000580dc] 33e8 000e 000d 4be8       move.w     14(a0),$000D4BE8
[000580e4] 4eb9 0005 83dc            jsr        $000583DC
...
[00058112] 6714                      beq.s      $00058128
[00058114] 5540                      subq.w     #2,d0
[00058116] 6764                      beq.s      $0005817C
[00058118] 907c 000a                 sub.w      #$000A,d0
[0005811c] 6700 0084                 beq        $000581A2
[00058120] 5940                      subq.w     #4,d0
[00058122] 6724                      beq.s      $00058148
[00058124] 6000 009a                 bra        $000581C0
...
[000581fc] 6708                      beq.s      $00058206
[000581fe] 206f 001a                 movea.l    26(a7),a0
[00058202] 6100 fc78                 bsr        $00057E7C
[00058206] 6006                      bra.s      $0005820E
[00058208] 2f6f 000e 0004            move.l     14(a7),4(a7)
[0005820e] 202f 0004                 move.l     4(a7),d0
[00058212] 671e                      beq.s      $00058232
[00058214] 4879 0006 2c64            pea.l      $00062C64
[0005821a] 226f 0008                 movea.l    8(a7),a1
[0005821e] 2079 000d 450e            movea.l    $000D450E,a0
[00058224] 2479 000d 450e            movea.l    $000D450E,a2
[0005822a] 246a 0018                 movea.l    24(a2),a2
[0005822e] 4e92                      jsr        (a2)
[00058230] 584f                      addq.w     #4,a7
[00058232] 2017                      move.l     (a7),d0
[00058234] 671e                      beq.s      $00058254
[00058236] 4879 0006 2c64            pea.l      $00062C64
[0005823c] 226f 0004                 movea.l    4(a7),a1
[00058240] 2079 000d 450e            movea.l    $000D450E,a0
[00058246] 2479 000d 450e            movea.l    $000D450E,a2
...
[00058282] 4eb9 0004 7ff8            jsr        $00047FF8
[00058288] 4a40                      tst.w      d0
[0005828a] 672e                      beq.s      $000582BA
[0005828c] 206f 0012                 movea.l    18(a7),a0
[00058290] 3f68 000a 000a            move.w     10(a0),10(a7)
[00058296] 426f 0010                 clr.w      16(a7)
[0005829a] 487a fd1c                 pea.l      $00057FB8(pc)
[0005829e] 487a fc54                 pea.l      $00057EF4(pc)
[000582a2] 43ef 0008                 lea.l      8(a7),a1
[000582a6] 2079 000d 4bde            movea.l    $000D4BDE,a0
[000582ac] 2479 000d 4bde            movea.l    $000D4BDE,a2
...
[000582d6] 487a fbfc                 pea.l      $00057ED4(pc)
[000582da] 226f 0008                 movea.l    8(a7),a1
[000582de] 43e9 000a                 lea.l      10(a1),a1
[000582e2] 2079 000d 4bde            movea.l    $000D4BDE,a0
[000582e8] 2479 000d 4bde            movea.l    $000D4BDE,a2
...
[0005834c] 0c79 1249 000d 4bec       cmpi.w     #$1249,$000D4BEC
[00058354] 662a                      bne.s      $00058380
...
[00058364] 4eb9 0007 6f2e            jsr        $00076F2E
[0005836a] 4a40                      tst.w      d0
[0005836c] 6612                      bne.s      $00058380
[0005836e] 7210                      moveq.l    #16,d1
[00058370] 70ff                      moveq.l    #-1,d0
[00058372] 41f9 000d 4bec            lea.l      $000D4BEC,a0
[00058378] 4eb9 0007 712e            jsr        $0007712E
[0005837e] 6052                      bra.s      $000583D2
...
[000583c0] 4eb9 0006 a818            jsr        $0006A818
[000583c6] 4a40                      tst.w      d0
[000583c8] 6704                      beq.s      $000583CE
[000583ca] 7001                      moveq.l    #1,d0
[000583cc] 6002                      bra.s      $000583D0
...
[000583e4] 3039 000d 4be2            move.w     $000D4BE2,d0
[000583ea] 6b5c                      bmi.s      $00058448
[000583ec] 2079 0010 1f12            movea.l    ACSblk,a0
[000583f2] 3039 000d 4be2            move.w     $000D4BE2,d0
[000583f8] b050                      cmp.w      (a0),d0
[000583fa] 674c                      beq.s      $00058448
[000583fc] 7210                      moveq.l    #16,d1
[000583fe] 4240                      clr.w      d0
[00058400] 41d7                      lea.l      (a7),a0
[00058402] 4eb9 0007 712e            jsr        $0007712E
...
[00058424] 2279 000d 99d6            movea.l    $000D99D6,a1
[0005842a] 41d7                      lea.l      (a7),a0
[0005842c] 7210                      moveq.l    #16,d1
[0005842e] 3039 000d 4be2            move.w     $000D4BE2,d0
[00058434] 4eb9 0006 a818            jsr        $0006A818
[0005843a] 4a40                      tst.w      d0
[0005843c] 6704                      beq.s      $00058442
[0005843e] 7001                      moveq.l    #1,d0
[00058440] 6002                      bra.s      $00058444
...
[0005845a] 6100 f99c                 bsr        $00057DF8
[0005845e] 4a40                      tst.w      d0
[00058460] 676c                      beq.s      $000584CE
[00058462] 7210                      moveq.l    #16,d1
[00058464] 4240                      clr.w      d0
[00058466] 41d7                      lea.l      (a7),a0
[00058468] 4eb9 0007 712e            jsr        $0007712E
[0005846e] 3ebc 4951                 move.w     #$4951,(a7)
[00058472] 2079 0010 1f12            movea.l    ACSblk,a0
[00058478] 3f50 0002                 move.w     (a0),2(a7)
[0005847c] 2279 000d 99d6            movea.l    $000D99D6,a1
[00058482] 41d7                      lea.l      (a7),a0
[00058484] 7210                      moveq.l    #16,d1
[00058486] 3039 000d 4be2            move.w     $000D4BE2,d0
[0005848c] 4eb9 0006 a818            jsr        $0006A818
[00058492] 4a40                      tst.w      d0
[00058494] 6704                      beq.s      $0005849A
[00058496] 7001                      moveq.l    #1,d0
[00058498] 6002                      bra.s      $0005849C
[0005849a] 4240                      clr.w      d0
[0005849c] 3f40 0010                 move.w     d0,16(a7)
[000584a0] 33fc ffff 000d 4be2       move.w     #$FFFF,$000D4BE2
[000584a8] 4279 000d 4be4            clr.w      $000D4BE4
[000584ae] 33fc ffff 000d 4be6       move.w     #$FFFF,$000D4BE6
[000584b6] 4279 000d 4bea            clr.w      $000D4BEA
[000584bc] 2079 000d 4bde            movea.l    $000D4BDE,a0
[000584c2] 2279 000d 4bde            movea.l    $000D4BDE,a1
...
[0005858a] 6044                      bra.s      $000585D0
[0005858c] 206f 002c                 movea.l    44(a7),a0
[00058590] 4eb9 0007 69b0            jsr        $000769B0
[00058596] 5280                      addq.l     #1,d0
[00058598] 4eb9 0004 7f44            jsr        $00047F44
[0005859e] 2e88                      move.l     a0,(a7)
[000585a0] 2017                      move.l     (a7),d0
[000585a2] 6604                      bne.s      $000585A8
[000585a4] 4240                      clr.w      d0
[000585a6] 6052                      bra.s      $000585FA
[000585a8] 2257                      movea.l    (a7),a1
[000585aa] 2079 000d 450e            movea.l    $000D450E,a0
[000585b0] 2479 000d 450e            movea.l    $000D450E,a2
[000585b6] 246a 000c                 movea.l    12(a2),a2
[000585ba] 4e92                      jsr        (a2)
[000585bc] 226f 002c                 movea.l    44(a7),a1
[000585c0] 2057                      movea.l    (a7),a0
[000585c2] 4eb9 0007 6950            jsr        $00076950
[000585c8] 2f57 0020                 move.l     (a7),32(a7)
[000585cc] 426f 0024                 clr.w      36(a7)
[000585d0] 2279 000d 99d6            movea.l    $000D99D6,a1
[000585d6] 41ef 001a                 lea.l      26(a7),a0
[000585da] 7210                      moveq.l    #16,d1
[000585dc] 3039 000d 4be2            move.w     $000D4BE2,d0
[000585e2] 4eb9 0006 a818            jsr        $0006A818
[000585e8] 4a40                      tst.w      d0
[000585ea] 6704                      beq.s      $000585F0
[000585ec] 7001                      moveq.l    #1,d0
[000585ee] 6002                      bra.s      $000585F2
