...
static AUSERBLK A_USERBLK01 = { A_3Dbutton, 0xa02191f8L, Auo_string, NULL, NULL, NULL, NULL, NULL };
static AUSERBLK A_USERBLK02 = { A_3Dbutton, 0x29c10178L, Auo_string, TEXT_01, NULL, NULL, NULL, NULL };
static AUSERBLK A_USERBLK03 = { A_3Dbutton, 0x29e201f8L, Auo_string, NULL, NULL, NULL, NULL, NULL };
static AUSERBLK A_USERBLK04 = { A_3Dbutton, 0x29c10178L, Auo_string, TEXT_04, NULL, NULL, NULL, NULL };
static AUSERBLK A_USERBLK05 = { A_3Dbutton, 0xa10211a1L, Auo_string, NULL, NULL, NULL, NULL, NULL };

static AUSERBLK A_FTEXT01 = { A_ftext, 0x00118000L, Auo_ftext, TEXT_05, NULL, NULL, NULL, NULL };

static AUSERBLK A_PICTURE01 = { A_picture, 0L, Auo_picture, DATAS_01, NULL, NULL, NULL, NULL };
...
static void pic_click(void)
{
	...
	if (ACSblk->ev_object[ACSblk->ev_obnr].ob_state & AOS_DCLICK)
	{
		...
		{
			x = (int)strtol(win->work[DIM_X].ob_spec.tedinfo->te_ptext, NULL, 10);
			y = (int)strtol(win->work[DIM_Y].ob_spec.tedinfo->te_ptext, NULL, 10);
			w = (int)strtol(win->work[DIM_W].ob_spec.tedinfo->te_ptext, NULL, 10);
			h = (int)strtol(win->work[DIM_H].ob_spec.tedinfo->te_ptext, NULL, 10);
		}
		Awi_delete(win);
	} else
	{
