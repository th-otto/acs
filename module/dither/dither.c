...
static AUSERBLK A_3DBUTTON01 = { A_3Dbutton, 0x29c10178L, Auo_string, TEXT_001, NULL, NULL };
static AUSERBLK A_3DBUTTON02 = { A_3Dbutton, 0x29c10178L, Auo_string, TEXT_002, NULL, NULL };
static AUSERBLK A_3DBUTTON03 = { A_3Dbutton, 0x29e20178L, Auo_string, NULL, NULL, NULL };

static AUSERBLK A_CHECKBOX01 = { A_checkbox, 0x00000001L, Auo_string, TEXT_008, NULL, NULL };
static AUSERBLK A_CHECKBOX02 = { A_checkbox, 0x00000001L, Auo_string, TEXT_007, NULL, NULL };
static AUSERBLK A_CHECKBOX03 = { A_checkbox, 0x00000001L, Auo_string, TEXT_006, NULL, NULL };

static AUSERBLK A_FRAME01 = { A_innerframe, 0x10008f19L, Auo_string, TEXT_004, NULL, NULL };
static AUSERBLK A_FRAME02 = { A_innerframe, 0x10008f19L, Auo_string, TEXT_005, NULL, NULL };
static AUSERBLK A_FRAME03 = { A_innerframe, 0x10008f19L, Auo_string, TEXT_009, NULL, NULL };
...
static void click_large(void)
{
	...
	if (obj->ob_state & OS_SELECTED)
	{
		...
		auser->ub_serv(cancel, AUO_SETVAL, TEXT_002);
	} else
	{
		ACSblk->dither |= ACS_DITHER_LARGE;
	}
