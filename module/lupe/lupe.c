...
static AUSERBLK USERBLK01 = { A_3Dbutton, 0xa02191f8L, Auo_string, NULL, NULL, NULL, NULL, NULL };
static AUSERBLK USERBLK02 = { A_3Dbutton, 0x29e201f8L, Auo_string, NULL, NULL, NULL, NULL, NULL };
static AUSERBLK USERBLK03 = { A_arrows, 0x22090001L, NULL, NULL, NULL, NULL, NULL, NULL };
static AUSERBLK USERBLK04 = { A_ftext, 0x00118000L, Auo_ftext, TEXT_005, NULL, NULL, NULL, NULL };
...
static AUSERBLK lupe_user = { lupe_draw, 0L, NULL, NULL, NULL, NULL, NULL, NULL };
...
static Awindow *lupe_create(void *para)
{
	...
	if (lupe_winptr == NULL)
	{
		lupe_winptr = Awi_create(&lupe_win);
		if (lupe_winptr == NULL)
			return NULL;
		change_zoom(32, 32);
...
static boolean lupe_service(Awindow *self, int16 task, void *in_out)
{
	...
	case AS_INFO:
		self = settings_win.create(&settings_win);
		if (self != NULL)
		{
			Awi_dialog(self);
			Awi_delete(self);
